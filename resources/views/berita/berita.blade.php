                            ...
                            <div class="card ijo-atas">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row card-berita">
                                        <div class="col-12">
                                            <h5 class="d-flex ">
                                                <b class="text-success pl-2">BERITA PENTASYARUFAN</b>
                                            </h5>
                                                ...
                                                <div class="form-row mt-2">
                                                    ...
                                                    @if (Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == 'ef77ea4b-725b-11ed-ad27-e4a8df91d8b3')
                                                        <div class="col-12 col-md-2 col-sm-12 mb-2 mb-xl-0">
                                                            <a href="/{{ $role }}/arsip/tambah_berita"
                                                                class="btn btn btn-success btn-block" type="button"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <b style="font-size: 12pt;">
                                                            @if ($data_berita->kategori_berita == 'Lazisnu Cilacap')
                                                                Lazisnu Cilacap
                                                            @elseif($data_berita->kategori_berita == 'Upzis MWCNU')
                                                                {{ App\Http\Controllers\BeritaUmumController::nama_upzis($data_berita->id_upzis) }}
                                                            @elseif($data_berita->kategori_berita == 'Ranting NU')
                                                                {{ App\Http\Controllers\BeritaUmumController::nama_ranting($data_berita->id_ranting) }}
                                                            @endif
                                                        </b><br>
                                                        ...
                                                        <span style="font-size: 10pt;">
                                                            {{ \Carbon\Carbon::parse($data_berita->tanggal_terbit)->isoFormat('dddd, D MMMM Y') }}
                                                        </span>
                ...
                function klikkene(value) {
                    introJs().setOptions({
                            steps: [{
                                    ...
                                    intro: 'Berita Pentasyarufan dapat dibuat oleh Divisi IT & Media'
                                },
                                {
                                    element: document.querySelector('.card-filter-berita'),
                                    title: 'Filter Berita',
                                    intro: 'Untuk Menampilkan arsip Berita Pentasyarufan secara spesifik, gunakan filter data'
                                },
                                {
                                    element: document.querySelector('.card-tambah-berita'),
                                    title: 'Tambah Berita',
                                    intro: 'Klik disini untuk membuat Berita Pentasyarufan baru'
                                },

                                {
                                    element: document.querySelector('.card-table-berita'),
                                    title: 'Data Berita Pentasyarufan',
                                    intro: 'Arsip Berita Pentasyarufan akan tampil pada tabel & Tersinkronasi dengan Aplikasi GOCAP'
                                }
                            ]
