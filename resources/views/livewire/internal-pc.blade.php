<div>
    ...
    <div class="card">
        <div class="card-body intro-header-data-pengajuan-pcs">
            ...
            <form action="/{{ $role }}/filter_internal_pc_post" method="post" id="filterFormInternal">
                @csrf
                ...
                <div class="form-row intro-filter-data-pengajuan-pc">
                    ...
                    <div class="col-12 col-md-3 col-sm-12 mb-2 mb-xl-0">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control text-center icon-input" id="reportrange" wire:ignore
                        ...
                        <div class="btn-group btn-block ">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" onMouseOver="this.style.color='red'"
                                    ...
                                    href="/{{ $role }}/print_internal/{{ $filter_daterange }}/{{ $filter_status }}/{{ $filter_tujuan }}"
                                    target="_blank">
                                    <i class="fas fa-file-pdf"></i>&nbsp; Pdf
                                </a>
                                <a class="dropdown-item" onMouseOver="this.style.color='green'"
                                    onMouseOut="this.style.color='black'" type="button"
                                    href="/{{ $role }}/print_internal_excel/{{ $filter_daterange }}/{{ $filter_status }}/{{ $filter_tujuan }}">
