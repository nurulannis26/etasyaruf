        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="col-12 col-md-4 col-sm-12 mb-2 mb-xl-0">
                    <div class="input-group">
                        ...
                        <input wire:model="tanggal_mulai" id="tanggal_mulai" wire:loading.attr="disabled" type="date"
                            class="form-control" placeholder="Tanggal Mulai" max="">
                    </div>
                </div>
                {{-- end tanggal mulai --}}
                ...
                <div class="col-12 col-md-2 col-sm-12 mb-2 mb-xl-0">
                    <select wire:model="id_program" wire:loading.attr="disabled" id="id_program" class="form-control">
            ...
            <div class="form-row mt-2">
                ...
                <div class="col-12 col-md-10 col-sm-12 mb-2 mb-xl-0">
                    <div class="d-flex flex-row bd-highlight align-items-center">
                        ...
                        <div class="p-1 bd-highlight">
                            <span>Menampilkan data pengajuan pentasyarufan
                ...
                <div class="col-12 col-md-1 col-sm-12 mb-2 mb-xl-0">
                    <button class="btn btn-secondary btn-block tombol-reset-pc" wire:click="reset_filter_internal_pc"><i
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a onMouseOver="this.style.color='blue'" onMouseOut="this.style.color='black'"
                                    class="dropdown-item" href="/{{ $role }}/detail_pengajuan"
