<div class="row">
            ...
            <div>
                ...
                <p class="intro-detail-data-pengajuan-status-lembar-rekomendasi d-inline">
                    @if ($data->status_rekomendasi == 'Belum Terbit')
                        <sup class="badge badge-danger text-white bg-secondary mb-2 hover">Belum Terbit Rekom</sup>
                    @elseif ($data->status_rekomendasi == 'Ditolak')
                        <sup class="badge badge-danger text-white bg-danger mb-2 hover">Rekom Ditolak</sup>
                    @else
    ...
    <div class="col col-md-6 col-sm-12">
        ...
        @if (Auth::user()->gocap_id_pc_pengurus != null and
            ...
            @elseif($data->status_rekomendasi == 'Ditolak')
                <div class="callout callout-success mt-2">
                    ...
                    <br>
                    <button class="btn btn-sm btn-secondary hover mt-2" data-toggle="collapse"
                        data-target="#batalTolakRekomendasi" aria-expanded="false"
                        aria-controls="batalTolakRekomendasi">
                        Batalkan Penolakan?</button>
                </div>
            @else
                <div class="callout callout-success mt-2">
                    <span style="font-size: 12pt;" class="text-bold"><i
                            class="fas fa-check-circle mr-1"></i>Rekomendasi
                        sudah diterbitkan
                    </span>
                    <br>
                    <button class="btn btn-sm btn-secondary hover mt-2" data-toggle="collapse"
        ...
        <div class="collapse mt-2" id="batalTolakRekomendasi">
            <div class="card card-body" style="background-color:#ffbbbb">
                <span class=" text-bold">
                    <em>Setelah melakukan pembatalan penolakan, rekomendasi dapat dilakukan respon ulang </em>
                </span>
                <div class="float-left mt-1">
                    <button wire:click="batalTolakRekomendasi('{{ $data->id_pengajuan ?? null }}')"
                        class="btn btn-sm btn-danger hover"><i class="fas fa-check-circle"></i>
                        Iya, Saya Ingin Membatalkan Penolakan Rekomendasi Ini</button>
                </div>
                <div class="ml-auto mr-1">
                    <div wire:loading>
                        Dalam Proses , Harap Tunggu....
                    </div>
                </div>
            </div>
        </div>
            ...
            @if ($data->status_rekomendasi == 'Sudah Terbit')
                <div class="callout callout-success mt-2">
                    ...
                    @if (Auth::user()->gocap_id_pc_pengurus != null and
                        ...
                        @if ($data->notif_rekomendasi == '1')
                            <button wire:click="statusCair()" class="btn btn-sm btn-secondary hover mt-2"
                                data-toggle="collapse" data-target="#statusCair" aria-expanded="false"
                                aria-controls="statusCair"> Status Cair
                            </button>
                        @else
                            <button wire:click="statusCair()" class="btn btn-sm btn-secondary hover mt-2"
                                data-toggle="collapse" data-target="#statusCair" aria-expanded="false"
                                aria-controls="statusCair" disabled> Status Cair
                            </button>
                        @endif
                    @endif
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="ml-auto mr-1">
                            ...
                            <div wire:loading.remove>
                                <button wire:click="tolakRekomendasi" class="btn btn-danger hover"><i
                                        class="fas fa-check-circle"></i>
                                    Tolak Rekomendasi</button>
        ...
        @if ($detail_jurnal != "")
        @if ($data->status_rekomendasi == 'Sudah Terbit' && Auth::user()->gocap_id_pc_pengurus != null)
        <div class="col col-md-12 col-sm-12">
            <div class="col-12">
                <div class="card card-outline mb-0 pb-0" style="border-radius: 10px;">
                    <div class="card-body">
                        <div class="row mb-0 pb-0 pl-0">
                            ...
                            <script>
                                var dropdownToggle = document.getElementById("editDropdownToggle");
                                var editDropdownMenu = document.querySelector(".dropdown.dropleft .dropdown-menu");
