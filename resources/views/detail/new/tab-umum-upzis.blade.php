    ...
    <div class="card-body ">
        ...
        <form action="/{{ $role }}/filter_umum_upzis" method="post" id="filterFormUpzis">
            ...
            <div class="form-row ">
                    ...
                    <div class="input-group ">
                        <select onchange="submitFormUpzis()" name="status_lpj" class="form-control select2 text-center"
                            ...
                            <option value="Belum Selesai LPJ"
                                {{ $status_lpj == 'Belum Selesai LPJ' ? 'selected' : '' }}>
                                Belum Selesai LPJ
                            </option>
                        </select>
                    </div>
                ...
                @if (Auth::user()->gocap_id_pc_pengurus != null)
                    <div class="col-12 col-md-9 col-sm-12  mb-xl-0">
                ...
                @else
                    <div class="col-12 col-md-7 col-sm-12  mb-xl-0">
                        <div class="d-flex flex-row bd-highlight align-items-center">
                            <div class="p-1 bd-highlight">
                                <i class="fas fa-info-circle"></i>
                            </div>
                    ...
                    <div class="btn btn-group btn-block p-0 m-0" role="group">
                        ...
                        <div class="dropdown-menu btn-block" style="border-radius: 10px">
                            ...
                            <a class="dropdown-item btn-block" target="_blank"
                                href="{{ route('pengajuan_pdf_umum_upzis_realisasi_pengajuan', [
                                    'role' => $role,
                                    'status' => $status,
                ...
                @else
                    <div class="col-12 col-md-2 col-sm-12  mb-xl-0">
                            ...
                            style="cursor: pointer" data-target="#tambah-pengajuan-upzis" type="button"><i
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            ...
                            Pengajuan
                            ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_total', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            Program)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_dalam_proses', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            Pengajuan
                            ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_dalam_proses', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_terbit_rekom', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            Pengajuan
                            ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_terbit_rekom', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('sudah_lpj', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
