                        ...
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <tr class="intro-detail-data-pengajuan-konfirmasi-format-berkas-download">
                                    ...
                                    or Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == 'e7fc67fe-725b-11ed-ad27-e4a8df91d8b3' or Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8e2ba55e-725b-11ed-ad27-e4a8df91d8b3')
                    ...
                    <div class="dana-dokumentasi-detail-umum-pc">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @if (Auth::user()->gocap_id_pc_pengurus == $data->pj_pc or
                                    Auth::user()->gocap_id_pc_pengurus == '9f14046b-a733-4ef8-a3a4-db8185a889e8' or Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == 'e7fc67fe-725b-11ed-ad27-e4a8df91d8b3' or Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8e2ba55e-725b-11ed-ad27-e4a8df91d8b3')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="dana" style="width:100%">
                        <thead>
                            <tr class="text-center">
