...
<div class="card intro-card-data-pengajuan">
    <div class="card-body ">
        ...
        {{-- row1 1 --}}
        <form action="/{{ $role }}/filter_laporan_gabungan_keseluruhan" method="post" id="filterFormKeseluruhan">
            @csrf
            ...
            <input type="hidden" name="filter_status" value="semua">
            <input type="hidden" name="filter_kategori" value="semua">
            <input type="hidden" name="filter_pilar" value="semua">
                    ...
                    <div class="btn-group btn-block">
                        ...
                        <div class="dropdown-menu" style="border-radius: 10px;">
                            <a class="dropdown-item btn-block" target="_blank"
                                href="{{ route('pdf_all_umum_laporan_gabungan', [
                                    'role' => $role,
                                    'status' => $status2,
                            ...
                            <a class="dropdown-item btn-block" target="_blank"
                                href="{{ route('berita_acara_laporan_gabungan', [
                                    'role' => $role,
                                    'status' => $status2,
                                    'start_date' => $start_date2,
                                    'end_date' => $end_date2,
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col">
                                ...
                                @php
                                    $nominal = App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('nominal_total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                                @endphp
                                <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>

                                <div class="h6 mb-0 mb-1" style="color: #28a745">
                                    {{ App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                                    Pengajuan
                                    ({{ App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('program_total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                                    Program)</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col">
                                ...
                                <div class="h6 mb-0 mb-1" style="color: #28a745">
                                    {{ App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('total_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                                    Pengajuan
                                    ({{ App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('program_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                                    Program)</div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col">
                                ...
                                @php
                                    $nominal = App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('nominal_sudah_lpj', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                                @endphp
                                <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>

                                <div class="h6 mb-0 mb-1" style="color: #28a745">
                                    {{ App\Http\Controllers\ChartLaporanGabungan::getStatisticPengajuan('sudah_lpj', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div style="margin-left:5px; ">
            <b style="font-size:16px;">
                Data Realisasi By Pengajuan Tingkat UPZIS & Ranting Seluruh Kecamatan</b>
        </div>
        <div>
...
<div class="table-responsive card card-body">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div style="margin-left:5px; ">
            <b style="font-size:16px;">
                Data Realisasi Pengajuan Umum Pc</b>
        </div>
        <div>
            <div class="btn btn-group btn-block p-0 m-0" role="group">
                <button type="button" class="btn btn-outline-success dropdown-toggle" data-toggle="dropdown"
                ...
                <div class="dropdown-menu btn-block" style="border-radius: 10px">
                    ...
                    <a class="dropdown-item" target="_blank"
                        href="{{ route('print_pc_laporan_gabungan', [
                            'filter_daterange2' => $filter_daterange2,
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover" id="umum_pc_laporan" style="width:100%">
                    ...
                    <tr onclick="openInNewTab('/pc/detail-pengajuan-pc/{{ $abc->id_pengajuan }}');"
                        ...
                        <td style=" cursor: pointer;font-size: 12pt;width: 30%; ">
                            ...
                            <div class="d-flex justify-content-between" style="font-size: 13px">
                                <div>Pengajuan</div>
                                <div class="text-bold">
                                    Rp{{ number_format($abc->nominal_pengajuan), 0, '.', '.' }},-
                                </div>
                            </div>
                            <div class="d-flex justify-content-between" style="font-size: 13px">
                                <div>Tgl Pengajuan</div>
                                <div class="text-bold">
                                    {{ Carbon\Carbon::parse($abc->tgl_pengajuan)->isoFormat('D MMMM Y') }}
                                </div>
                            </div>
                            <div class="d-flex justify-content-between" style="font-size: 13px">
                                <div>Tgl Input</div>
                                <div class="text-bold">
                                    {{ Carbon\Carbon::parse($abc->created_at)->isoFormat('D MMMM Y') }}
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-bold" style="font-size: 13px">
                                    ...
                                    @elseif($abc->opsi_pemohon == 'Individu')
                                        {{ $abc->nama_pemohon }}
                                    @elseif($abc->opsi_pemohon == 'Internal')
                                        @php
                                            $nama_pengurus_internal = App\Models\Pengguna::where('gocap_id_pc_pengurus', $abc->pemohon_internal)->value('nama');
                                        @endphp
                                        {{ $nama_pengurus_internal ?? '' }}
                                    @endif
                                </div>
                            </div>
                        ...
                        <td style="cursor: pointer; width: 16%;">
                            @if ($abc->approval_status_divpro == 'Disetujui')
                            ...
                            @if ($abc->approval_status_divpro == 'Disetujui')
                                @if ($abc->approval_status == 'Disetujui')
                                    <sup class="text-light badge badge-success">Disposisi Disetujui
                                        Direktur</sup>
                                @elseif($abc->approval_status == 'Ditolak')
                            ...
                            <div class="row">
                                ...
                                <div class="col text-bold text-right" style="font-size: 10pt;">
                                    @php
                                        $jml_penerima = App\Models\PengajuanDetail::where('id_pengajuan', $abc->id_pengajuan)->sum('jumlah_penerima');
                                    @endphp
                                    {{ $jml_penerima }}
                                </div>
                            </div>
                            <div class="text-left" style="font-size: 10pt;">
                                <span class="text-bold" style="font-size: 10pt;">
                                    Asnaf
                                    {{ DB::table('asnaf')->where('id_asnaf', $abc->id_asnaf)->value('nama_asnaf') ?? '-' }}
                                </span>
                                <br>
                                <span class="text-bold" style="font-size: 10pt;">
                                    {{ App\Models\ProgramPilar::where('id_program_pilar', $abc->id_program_pilar)->value('pilar') ?? '-' }}
                                </span>
                                <br>
                                {{-- digantii --}}
                                <span>
                                    {{ App\Models\ProgramKegiatan::where('id_program_kegiatan', $abc->id_program_kegiatan)->value('nama_program') ?? '-' }}
                                </span>
                                <br>
                                <em class="text-secondary">
                                    {{ $abc->pengajuan_note ?? '-' }}
                        ...
                        <td style=" cursor: pointer; width: 15%;">
                            @if ($abc->approval_status == 'Disetujui')
                                @if ($abc->pil_survey == 'Perlu')
                                    @if ($abc->status_survey == 'Direncanakan')
                                        <sup class="text-light badge badge-warning">Survey Blm Selesai</sup>
                                    @elseif($abc->status_survey == 'Diajukan')
                                        <sup class="text-light badge badge-success">Survey Selesai
                                        </sup>
                                    @endif
                                @elseif($abc->pil_survey == 'Tidak Perlu')
                            ...
                            @if ($abc->pil_survey == 'Perlu')
                                <div class="text-right" style="font-size: 10pt;">
                                    @php
                                        $disetujui = App\Models\SurveyPenerimaManfaat::where('id_pengajuan', $abc->id_pengajuan)
                                            ->where('hasil', 'disetujui')
                                            ->count();

                                        $ditolak = App\Models\SurveyPenerimaManfaat::where('id_pengajuan', $abc->id_pengajuan)
                                            ->where('hasil', 'ditolak')
                                            ->count();
                                        ...
                                        $belum_disurvey = App\Models\PengajuanPenerima::leftJoin('survey_penerima_manfaat', function ($join) {
                                            ...
                                            ->where('pengajuan_penerima.id_pengajuan', $abc->id_pengajuan)
                                            ->count();
                        ...
                        <td style=" cursor: pointer; width: 15%;">
                            @if ($abc->pil_survey == 'Tidak Perlu')
                                @if ($abc->approval_status_pencairan_direktur == 'Disetujui')
                                    <sup class="text-light badge badge-success">Pencairan Disetujui Direktur
                                    </sup>
                                @elseif ($abc->approval_status_pencairan_direktur == 'Ditolak')
                                    <sup class="text-light badge badge-danger">Pencairan Ditolak Direktur
                                    </sup>
                                @endif
                            @elseif($abc->pil_survey == 'Perlu' && $abc->status_survey == 'Diajukan')
                                @if ($abc->approval_status_pencairan_direktur == 'Disetujui')
                                    <sup class="text-light badge badge-success">Pencairan Disetujui Direktur
                                    </sup>
                                @elseif ($abc->approval_status_pencairan_direktur == 'Ditolak')
                            ...
                            <div class="text-left" style="font-size: 10pt;">
                                <span class="text-secondary">
                                    @if ($abc->approval_status == 'Disetujui')
                                        {{ Carbon\Carbon::parse($abc->approval_date_pencairan_direktur)->isoFormat('D MMMM Y') }}
                                    @else
                                        Blm Disetujui
                                    @endif
                                </span>
                            ...
                            <div class="row text-right">
                                ...
                                <div class="col text-bold text-right" style="font-size: 10pt;">
                                    <b class="text-success" style="font-size: 10pt;">
                                        Rp{{ number_format($abc->nominal_disetujui_pencairan_direktur), 0, '.', '.' }},-
                                    </b>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col text-bold text-right" style="font-size: 10pt;">
                                    <b class="text-success" style="font-size: 10pt;">
                                        Rp{{ number_format($abc->satuan_disetujui_pencairan_direktur), 0, '.', '.' }},-
                                    </b>
                                </div>
                            </div>
                        ...
                        <td style=" cursor: pointer; width: 15%;">
                            @if ($abc->approval_status_pencairan_direktur == 'Disetujui')
                                @if ($abc->pencairan_status == 'Berhasil Dicairkan')
                                    <sup class="text-light badge badge-success">Pencairan Disetujui Div. Keu
                                    </sup>
                                @elseif ($abc->pencairan_status == 'Ditolak')
                            ...
                            <div class="text-left" style="font-size: 10pt;">
                                <span class="text-secondary">
                                    @if ($abc->pencairan_status == 'Berhasil Dicairkan')
                                        {{ Carbon\Carbon::parse($abc->tgl_pencairan)->isoFormat('D MMMM Y') }}
                                    @else
                                        Blm Dicairkan
                                    @endif
                                </span>
                            ...
                            <div class="row text-right">
                                ...
                                <div class="col text-bold text-right" style="font-size: 10pt;">
                                    <b class="text-warning" style="font-size: 10pt;">
                                        Rp{{ number_format($abc->nominal_pencairan), 0, '.', '.' }},-
                                    </b>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col text-bold text-right" style="font-size: 10pt;">
                                    <b class="text-warning" style="font-size: 10pt;">
                                        Rp{{ number_format($abc->satuan_pencairan), 0, '.', '.' }},-
                                    </b>
                                </div>
                            </div>
                        ...
                        <td style=" cursor: pointer;width: 23%;">
                            @if ($abc->pencairan_status == 'Berhasil Dicairkan')
                                ...
                                @if ($abc->konfirmasi_lpj_div_prog != 'Dikonfirmasi')
                            ...
                            @elseif($abc->sumber_dana_opsi == 'Dana Zakat')
                            ...
                            @if ($abc->pencairan_status == 'Berhasil Dicairkan')
                                @php
                                    $rek = App\Models\Rekening::where('id_rekening', $abc->id_rekening)->first();
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div>
                ...
                <div class="dropdown-menu" style="border-radius: 10px">
                    ...
                    <a class="dropdown-item btn-block" target="_blank"
                        href="{{ route('excel_umum_gabungan', [
                            'role' => $role,
                            'status' => $status2,
                            'start_date' => $start_date2,
                            'end_date' => $end_date2,
            ...
            <table class="table table-bordered table-hover" style="font-size:14px; border-collapse: collapse;">
                ...
                <thead class="sticky-header bg-success" style="font-size:16px">
                    <tr>
                        ...
                        <th style="vertical-align:middle; text-align:center;width: 13%;">TGL <br> REKOM / REALISASI</th>
    ...
    <div class="table-responsive card card-body">
            ...
            <div>
                <div class="btn btn-group btn-block p-0 m-0" role="group">
                    ...
                    <div class="dropdown-menu btn-block" style="border-radius: 10px">
                        ...
                        <a class="dropdown-item btn-block" target="_blank"
                            href="{{ route('pdf_umum_gabungan_realisasi_penerima_manfaat', [
                                'role' => $role,
                                'status' => $status2,
                                'start_date' => $start_date2,
                                'end_date' => $end_date2,
                        ...
                        <a class="dropdown-item btn-block" target="_blank"
                            href="{{ route('excel_umum_gabungan_realisasi_penerima_manfaat', [
                                'role' => $role,
                                'status' => $status2,
                                'start_date' => $start_date2,
                                'end_date' => $end_date2,
        ...
        <table class="table table-bordered table-hover" id="Keseluruhan2" style="width:100%">
            ...
            <tbody>
                ...
                @php
                    $firstLoopCount = count($penerima_manfaat_keseluruhan);
                @endphp
                ...
                @foreach ($penerima_manfaat_keseluruhan2 as $p_manfaat_keseluruhan2)
                    <tr>
                        <td class="text-bold" style=" cursor: pointer;text-align:center;padding-top:3mm;">
                            {{ $loop->iteration + $firstLoopCount }}
                        </td>
                        <td>{{ Carbon\Carbon::parse($p_manfaat_keseluruhan2->tgl_bantuan)->isoFormat('D/M/Y') }}</td>
                        <td><b style="font-size:16px;">{{ $p_manfaat_keseluruhan2->nama }} </b><br>
                            NIK : {{ $p_manfaat_keseluruhan2->nik }} <br>
                            KK : {{ $p_manfaat_keseluruhan2->nokk }} <br>
                            NO HP : {{ $p_manfaat_keseluruhan2->nohp }}
                        </td>
                        <td>{{ $p_manfaat_keseluruhan2->alamat }}</td>
                        <td>Rp{{ number_format($p_manfaat_keseluruhan2->nominal_bantuan, 0, '.', '.') }},-</td>
                        <td>{{ $p_manfaat_keseluruhan2->nama_asnaf }}</td>
                        <td>{{ $p_manfaat_keseluruhan2->jenis_bantuan }}</td>
                        <td>{{ $p_manfaat_keseluruhan2->pilar }}</td>
                        <td>{{ $p_manfaat_keseluruhan2->nama_program }}</td>
        ...
        new Chart(ctxRanting, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        // penguat kelembagaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2, $status_lpj2) }},
                        // ekonomi
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2, $status_lpj2) }},
                        // pendidikan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2, $status_lpj2) }},
                        // kesehatan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2, $status_lpj2) }},
                        // dakwah kemanusiaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2, $status_lpj2) }},
                        // kemanusiaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2, $status_lpj2) }},
                        // lingkungan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2, $status_lpj2) }},
                    ]
                }, ]
            },
            options: {
        ...
        new Chart(ctxRantingNom, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        // penguat kelembagaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2, $status_lpj2) }},
                        // ekonomi
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2, $status_lpj2) }},
                        // pendidikan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2, $status_lpj2) }},
                        // kesehatan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2, $status_lpj2) }},
                        // dakwah kemanusiaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2, $status_lpj2) }},
                        // kemanusiaan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2, $status_lpj2) }},
                        // lingkungan
                        {{ App\Http\Controllers\ChartLaporanGabungan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2, $status_lpj2) }},
                    ]
                }, ]
            },
            options: {
