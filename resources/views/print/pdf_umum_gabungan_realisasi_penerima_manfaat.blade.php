...
@elseif($sub == 'laporan')
    <p style="margin:0pt; text-align:center; font-size:11pt;">
            <b>DATA REALISASI PENERIMA MANFAAT KESELURUHAN (PC LAZISNU, UPZIS,RANTING)</b>
        <br>
...
<table cellpadding="2" cellspacing="0" style="width:100%;border-collapse:collapse;font-size:10pt;">
    ...
    <tbody>
        ...
        @php
            $firstLoopCount = count($penerima_manfaat);
        @endphp

        @if (count($penerima_manfaat) > 0 || count($penerima_manfaat2) > 0)
            @foreach ($penerima_manfaat as $p_manfaat)
                <tr style="text-align: left; page-break-inside: avoid;">
                    <td
                        style="width: 3%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $loop->iteration }}
                    </td>
                    <td
                        style="width: 9%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ Carbon\Carbon::parse($p_manfaat->tgl_bantuan)->isoFormat('D/M/Y') }}
                    </td>
                    <td
                        style="width: 20%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:left;">
                    ...
                    <td
                        style="width: 15%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $p_manfaat->alamat }}
                    </td>
                    <td
                        style="width: 12%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        Rp{{ number_format($p_manfaat->nominal_bantuan, 0, '.', '.') }},-
                    </td>
                    <td
                        style="width: 8%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
            ...
            @foreach ($penerima_manfaat2 as $p_manfaat2)
                <tr style="text-align: left; page-break-inside: avoid;">
                    <td
                        style="width: 3%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                    ...
                    <td
                        style="width: 9%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ Carbon\Carbon::parse($p_manfaat2->tgl_bantuan)->isoFormat('D/M/Y') }}
                    </td>
                    <td
                        style="width: 20%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:left;">
                        <b style="font-size:10pt;">{{ $p_manfaat2->nama }} </b>
                        <br>
                        NIK : {{ $p_manfaat2->nik }} <br>
                        KK : {{ $p_manfaat2->nokk }} <br>
                        NO HP : {{ $p_manfaat2->nohp }}
                    </td>
                    <td
                        style="width: 15%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $p_manfaat2->alamat }}
                    ...
                    <td
                        style="width: 12%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        Rp{{ number_format($p_manfaat2->nominal_bantuan, 0, '.', '.') }},-
                    </td>
                    <td
                        style="width: 8%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $p_manfaat2->nama_asnaf }}
                    </td>
                    <td
                        style="width: 12%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $p_manfaat2->jenis_bantuan }}
                    </td>
                    <td
                        style="width: 12%;padding-left:3.0mm;border: 1px solid black; vertical-align:middle;text-align:center;">
                        {{ $p_manfaat2->pilar }}
