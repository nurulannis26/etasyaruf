        ...
        <div style="clear: both; ">
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%; border-collapse:collapse;">
                        ...
                        <td colspan="5" style="100%; padding-right:5.4pt; padding-left:5.4pt; vertical-align:top;">
                           <br>
                            <p
                                ...
                                <strong><span>LAMPIRAN TANDA SERAH TERIMA BANTUANN
                ...
                {{-- <table cellpadding="0" cellspacing="0"
                    ...
                    <thead>
                        <tr  style="text-align:center; border: 1px solid black; background-color:#cbf2d6;">
                    ...
                    <tbody>
                        ...
                        @forelse ($data_penerima_lpj as $a)
                            <tr style=" border: 1px solid black;font-size:11pt;">
                                <td  style="text-align:center;vertical-align:middle; border: 1px solid black;width: 3%;">
                                    {{ $loop->iteration }}</td>
                                <td style="padding-left:2mm;vertical-align:middle; border: 1px solid black;width: 27%;">
                                    {{ $a->nama }} <br>
                                    <span style="font-size:11pt;text-align:justify">NIK : {{ $a->nik ?? '-' }}
                                    </span><br>
                                    <span style="font-size:11pt;text-align:justify">KK &nbsp;: {{ $a->nokk ?? '-' }}
                                    </span>
                                </td>
                                <td style="padding-left:2mm;vertical-align:middle; border: 1px solid black;width: 30%;">
                                    {{ $a->alamat }}<br>
                                    <span style="font-size:11pt;text-align:justify">No.HP : {{ $a->nohp ?? '-' }}
                                    </span>
                                </td>
                                <td  style="text-align:center;padding-left:2mm;vertical-align:middle; border: 1px solid black;width: 10%;">
                                    Rp{{ number_format($a->nominal_bantuan, 0, '.', '.') }}<br>
                                    <span style="font-size: 11pt;">{{ $a->jenis_bantuan }}
                                    </span>
                                </td>
                                <td style="padding-left:2mm;vertical-align:middle; border: 1px solid black;width: 20%;">
                                    {{ Carbon\Carbon::parse($a->tgl_bantuan ?? null)->isoFormat('D MMMM Y') }}
                                    <br><span style="font-size: 11pt;"> {{ $a->keterangan }}
                                    </span>
                                </td>
