                        ...
                        <td style="width: 60%"><span>
                              ...
                              <!--              @endforeach -->
                                            ...
                                            @elseif($data->tingkat == 'Ranting NU')
                                                ...
                                                ({{ App\Http\Controllers\Helper::getNoRekening($bmtranting->id_rekening ?? '') }})
                                            @endif
                            </span></td>
                    </tr>
                @endif
                    ...
                    <td style="width: 60%">
                        ...
                        <!--@endif-->
                          ...
                          @if ($data->tingkat == 'Upzis MWCNU')
                            @if ($tipe == 'bmt')
                                Kelembagaan
                                ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'LEMBAGA')->pluck('no_rekening')->first() ?? null }}) <br>
                                ...
                                @if (App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first())
                                    Mobil Jenazah
                                    ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first() ?? null }}) <br>
                                    <b>
                                       Rp {{ number_format(App\Http\Controllers\PrintController::sumTotalByProgram($tipe, $data->id_pengajuan, 'MOBIL JENAZAH'), 0, '.', '.') }}</b><br>
                                @endif
                            @elseif($tipe == 'bri')
                                Kelembagaan
                                ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'LEMBAGA')->pluck('no_rekening')->first() ?? null }}) <br>
                                ...
                                <br>
                                Operasional
                                ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'OP')->pluck('no_rekening')->first() ?? null }}) <br>
                                <b>
                                    Rp {{ number_format(App\Http\Controllers\PrintController::sumTotalByProgram($tipe, $data->id_pengajuan, 'OP'), 0, '.', '.') }}</b><br>
                                @if (App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first())
                                    Mobil Jenazah
                                    ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first() ?? null }}) <br>
                                    <b>
