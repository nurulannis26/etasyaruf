    ...
    <div style="clear: both; ">
        ...
        <table
                ...
                <td style="width:55%;vertical-align: top; text-align: right; position: relative; text-transform: uppercase;"
                    colspan="3"><span class="custom-text">
                        @if ($internal->pencairan_status == 'Berhasil Dicairkan')
                            <b>{{ $internal->nomor_kwitansi_pencairan }}</b>
                        @else
                            -
                        @endif
                    </span>
            ...
            <tr>
                ...
                @php
                    $ttd_keuangan = App\Http\Controllers\PrintController::ttd($internal->staf_keuangan_pc);
                    $ttd_pemohon = App\Http\Controllers\PrintController::ttd($internal->maker_tingkat_pc);
                    // dd($ttd_pemohon);
                @endphp
