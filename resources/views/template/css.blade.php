...
<style>
    ...
    #select2StatusLPJ+.select2-container .select2-selection {
        border-radius: 8px;
        border-color: #c7c7c7;
        position: relative;
        /* background-image: url("/logo/info.png"); */
    ...
    #select2StatusLPJ+.select2-container .select2-selection:focus {
        transform: scale(1.03);
    }

    #select2StatusLPJ+.select2-container .select2-selection:hover {
        transform: scale(1.03);
    }


     #select2StatusLPJ2+.select2-container .select2-selection {
        border-radius: 8px;
        border-color: #c7c7c7;
        position: relative;
        /* background-image: url("/logo/info.png"); */
    ...
    #select2StatusLPJ2+.select2-container .select2-selection:focus {
        transform: scale(1.03);
    }

    #select2StatusLPJ2+.select2-container .select2-selection:hover {
        transform: scale(1.03);
    }
    ...
    #select2PemohonInternal+.select2-container .select2-selection {
        border-radius: 8px;
        border-color: #c7c7c7;
        position: relative;
        /* background-image: url("/logo/user.png"); */
