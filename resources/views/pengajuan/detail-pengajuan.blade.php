                                        ...
                                        <div class="btn btn-group btn-block  " role="group">
                                            <button type="button" class="btn btn-sm btn-outline-success dropdown-toggle"
                                                data-toggle="dropdown" aria-expanded="false"><i
                                                    class="fas fa-file-download"></i>&ensp;CETAK
                                            </button>
                                            <div class="dropdown-menu btn-block" style="border-radius: 10px">
                                                <a class="dropdown-item btn-block"
                                                    href="/{{ $role }}/laporan/{{ $data->id_pengajuan }}"
                                                    target="_blank"><i class="fas fa-file-pdf"></i> PDF</a>
                                                <a class="dropdown-item btn-block"
                                                    href="/{{ $role }}/laporan-excel/{{ $data->id_pengajuan }}"><i
                                                        class="fas fa-file-alt"></i> EXCEL</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-3 invoice-col">
                                        ...
                                        <address>
                                            ...
                                            <b>{{ \App\Http\Controllers\Helper::getNamaPengurus('upzis',
                                                $data->pj_upzis) }}</b><br>
                                            {{ \App\Http\Controllers\Helper::getJabatanPengurus('upzis',
                                            $data->pj_upzis) }}
                                            @else
                                            <b>{{ \App\Http\Controllers\Helper::getNamaPengurus('ranting',
                                                $data->pj_ranting) }}</b><br>
                                            {{ \App\Http\Controllers\Helper::getJabatanPengurus('ranting',
                                            $data->pj_ranting) }}
                                            @endif
                                        </address>
                                    </div>
                                    <div class="col-sm-3 invoice-col">
                                        ...
                                        <address>
                                            @if ($data->tingkat == 'Upzis MWCNU')
                                            <b>{{ \App\Http\Controllers\Helper::getNamaPengurus('upzis',
                                                $data->maker_tingkat_upzis) }}</b><br>
                                            {{ \App\Http\Controllers\Helper::getJabatanPengurus('upzis',
                                            $data->maker_tingkat_upzis) }}
                                            @else
                                            <b>{{ \App\Http\Controllers\Helper::getNamaPengurus('upzis',
                                                $data->maker_tingkat_upzis) }}</b><br>
                                            {{ \App\Http\Controllers\Helper::getJabatanPengurus('upzis',
