            ...
            introJs().setOptions({
                steps: [{
                    ...
                    },
                    {
                        ...
                        intro: 'Klik disini untuk menampilkan detail pengajuan (Pengajuan, Survey, Persetujuan Kepala Cabang, Pencairan Keuangan)'
                    ...
                    },
                    {
                        ...
                        intro: 'Menampilkan status pengajuan terkini (Menunggu Survey/Survey Ditolak/Menunggu Persetujuan/Ditolak Kepala Cabang/Menunggu Dicairkan/Berhasil Dicairkan)'
                    },
                    {
