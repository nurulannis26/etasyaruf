                            ...
                            <div class="tab-content " id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $act_tab_filter_internal_1 }}" id="internal" role="tabpanel"
                                    ...
                                    @if ($filter_internal == 'on')
                                        <livewire:internal-pc :c_filter_daterange="$c_filter_daterange" :c_filter_status="$c_filter_status"
                                ...
                                <div class="tab-pane fade {{ $act_tab_filter_pc_umum_1 }}" id="pc" role="tabpanel"
                                    ...
                                    @if ($filter_pc_umum == 'on')
                                        <livewire:umum-pc :c_filter_daterange2="$c_filter_daterange2" :c_filter_status="$c_filter_status"
                                        ...
                                        @elseif($filter_pc_umum == '')
                                            <livewire:umum-pc :filter_pc_umum="$filter_pc_umum" :sub="$sub">
                                    @endif
                                </div>
                                {{-- end internal pc --}}
