...
<main>
    ...
    <body>
        ...
        <div>
                ...
                <tbody>
                    <tr>
                        <td colspan="5"
                            ...
                            <p style="margin-top:0pt; margin-bottom:0pt; text-align:justify; line-height:125%; font-size:11pt;">
                                <strong><span>&nbsp;</span></strong>
                            </p>
                            <p style="margin-top:0pt; margin-bottom:0pt; text-align:justify; line-height:125%; font-size:11pt;">
                                <strong><span>&nbsp;</span></strong>
                    ...
                    <tr>
                        <td colspan="5" style=" padding-right:5.4pt; padding-left:5.4pt; vertical-align:top;">
                            <span style="margin-top:0pt; margin-bottom:0pt; line-height:125%; font-size:11pt;">
            ...
            <table style="width: 100%" >
                <tbody>
                    ...
                    <tr>
                        ...
                        <td 
                            style="width:160pt; padding-right:5.4pt; padding-left:5.4pt; vertical-align:top;">
                            <span
                                style="margin-top:0pt; margin-bottom:0pt; text-align:justify;  font-size:11pt;">
            ...
            <table style="width:100%" >
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" style="padding-right:5.4pt; padding-left:5.4pt;">
                            <span style=" font-size:11pt;">
                                    <strong>H. Berapa biaya / tanggungan / pengeluaran rutin setiap bulan dan untuk apa saja, jelaskan ?</strong>
                            </span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4" style="padding-right:5.4pt; padding-left:5.4pt;">
                            <span style=" font-size:11pt;">
                                    <strong>J. Bantuan apa saja yang sudah pernah di dapatkan, kapan  dan dari mana / siapa  ?</strong>
                            </span>
                        </td>
                    </tr>
                    <tr>
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td style="padding-left:5.4pt;">
                            ...
                            <div>
                                <div class="checkbox {{ $indeks_pendapatan=="layak"?"":"checked" }}"></div> Tidak Layak
                            </div>
                        </td>
                        <td style="padding-left:5.4pt;">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" style="padding-right:5.4pt; padding-left:5.4pt;">
                            <span style=" font-size:11pt;">
                                    <strong>K. Rekomendasi dari surveyor beserta alasan tentang kelayakan dalam penerimaan bantuan dari LAZISNU </strong>
                            </span>
                        </td>
                    </tr>
                    <tr>
            ...
            <p style="line-height:1000%; font-size:11pt;">
                <strong><span>&nbsp;</span></strong>
            </p>
            <table style="
            float: right;
