        ...
        new Chart(ctxRanting, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        // penguat kelembagaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2, $status2) }},
                        // ekonomi
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2, $status2) }},
                        // pendidikan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2, $status2) }},
                        // kesehatan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2, $status2) }},
                        // dakwah kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2, $status2) }},
                        // kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2, $status2) }},
                        // lingkungan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2, $status2) }},
                    ]
                }, ]
            },
            options: {
    ...
    new Chart(ctxRantingNom, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [
                    // penguat kelembagaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2, $status2) }},
                    // ekonomi
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2, $status2) }},
                    // pendidikan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2, $status2) }},
                    // kesehatan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2, $status2) }},
                    // dakwah kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2, $status2) }},
                    // kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2, $status2) }},
                    // lingkungan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2, $status2) }},
                ]
            }, ]
        },
        options: {
