...
<div class="card intro-card-data-pengajuan">
    <div class="card-body ">
        ...
        <form action="/{{ $role }}/filter_umum_upzis_laporan" method="post" id="filterFormUpzis">
            ...
            <input type="hidden" name="status_lpj2" value="semua">
            @php
                $status = 'semua';
                $status2 = 'semua';
            @endphp
            ...
            <div class="form-row ">
                ...
                <div class="col-12 col-md-3 col-sm-12 mb-2 mb-xl-0">
                    <div class="input-group ">
                        <select onchange="submitFormUpzis()" name="status_lpj" class="form-control select2 text-center"
                            id="select2StatusLPJ">
                            <option value="semua" {{ $status_lpj == 'semua' ? 'selected' : '' }}>
                                Semua Status LPJ
                            <option value="Selesai LPJ" {{ $status_lpj == 'Selesai LPJ' ? 'selected' : '' }}>
                                Selesai LPJ
                            </option>
                            <option value="Belum Selesai LPJ" {{ $status_lpj == 'Belum Selesai LPJ' ? 'selected' : '' }}>
                                Belum Selesai LPJ
                            </option>
                        </select>
                    </div>
                    ...
                    @if (Auth::user()->gocap_id_pc_pengurus != null)
                        <div class="btn btn-group btn-block p-0 m-0" role="group">
                            ...
                            <div class="dropdown-menu btn-block" style="border-radius: 10px">
                                ...
                                <a class="dropdown-item btn-block" target="_blank"
                                    href="{{ route('berita_acara_laporan_upzis', [
                                        'role' => $role,
                                        'status' => $status,
                                        'start_date' => $start_date,
                                        'end_date' => $end_date,
        ...
        new Chart(ctxUpzis, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        // penguat kelembagaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date, $end_date , $status_lpj) }},
                        // ekonomi
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date, $end_date , $status_lpj) }},
                        // pendidikan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date, $end_date , $status_lpj) }},
                        // kesehatan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date, $end_date , $status_lpj) }},
                        // dakwah kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date, $end_date , $status_lpj) }},
                        // kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date, $end_date , $status_lpj) }},
                        // lingkungan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('upzis', $id_upzis, null, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date, $end_date , $status_lpj) }},
                    ]
                }, ]
            },
            options: {
    ...
    new Chart(ctxUpzisNom, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [
                    // penguat kelembagaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date, $end_date, $status_lpj) }},
                    // ekonomi
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date, $end_date, $status_lpj) }},
                    // pendidikan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date, $end_date, $status_lpj) }},
                    // kesehatan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date, $end_date, $status_lpj) }},
                    // dakwah kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date, $end_date, $status_lpj) }},
                    // kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date, $end_date, $status_lpj) }},
                    // lingkungan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('upzis', $id_upzis, null, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date, $end_date, $status_lpj) }},
                ]
            }, ]
        },
        options: {
