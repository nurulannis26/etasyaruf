...
<div class="card intro-card-data-pengajuan">
    <div class="card-body ">
        ...
        {{-- row1 1 --}}
        <form action="/{{ $role }}/filter_umum_ranting_laporan" method="post" id="filterFormRanting">
            @csrf
          ...
          @endphp
            <div class="form-row ">
                ...
                <div class="col-12 {{ auth::user()->gocap_id_pc_pengurus != null ? 'col-md-3' : 'col-md-3' }} col-sm-12 mb-2 mb-xl-0">
                    <div class="input-group ">
                        <select onchange="submitFormRanting()" name="status_lpj2" class="form-control select2 text-center"
                            id="select2StatusLPJ2">
                            <option value="semua" {{ $status_lpj2 == 'semua' ? 'selected' : '' }}>
                                Semua Status LPJ
                            <option value="Selesai LPJ" {{ $status_lpj2 == 'Selesai LPJ' ? 'selected' : '' }}>
                                Selesai LPJ
                            </option>
                            <option value="Belum Selesai LPJ" {{ $status_lpj2 == 'Belum Selesai LPJ' ? 'selected' : '' }}>
                                Belum Selesai LPJ
                            </option>
                        </select>
                    </div>
        ...
        {{-- <div class="form-row">
            ...
            <div class="col-12 col-md-2 col-sm-12  mb-xl-0">
                <a href="#" class="btn btn-block btn-outline-success hover intro-ekspors-data-pengajuan">
                ...
                <div class="btn-group btn-block">
                    ...
                    <div class="dropdown-menu" style="border-radius: 10px;">
                        <a class="dropdown-item btn-block" target="_blank"
                            href="{{ route('pdf_all_umum_laporan_ranting', [
                                'role' => $role,
                                'status' => $status,
                        ...
                        <a class="dropdown-item btn-block" target="_blank"
                            href="{{ route('berita_acara_laporan_ranting', [
                                'role' => $role,
                                'status' => $status,
                                'start_date' => $start_date,
                                'end_date' => $end_date,
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\ChartLaporan::getStatisticPengajuan('nominal_total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Pengajuan
                            ({{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('program_total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Program)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        {{-- @php
                            $nominal = App\Http\Controllers\ChartLaporan::getStatisticPengajuan('nominal_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b> --}}
                        {{-- <b> Rp. 230.000.000</b> --}}
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('total_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Pengajuan
                            ({{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('program_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\ChartLaporan::getStatisticPengajuan('nominal_sudah_lpj', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('sudah_lpj', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        {{-- @php
                            $nominal = App\Http\Controllers\ChartLaporan::getStatisticPengajuan('nominal_dalam_proses', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2);
                        @endphp --}}
                        @php
                    ...
                    <b>{{ $total_jumlah_penerima_manfaat2 }} Orang</b>
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745"><br>
                            {{-- {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('total_dalam_proses', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Pengajuan
                            ({{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('program_dalam_proses', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            Program) --}}
                        </div>
        ...
        <div>
            <div class="btn btn-group btn-block p-0 m-0" role="group">
                ...
                <div class="dropdown-menu btn-block" style="border-radius: 10px">
                    ...
                    <a class="dropdown-item btn-block" target="_blank"
                        href="{{ route('pdf_umum_ranting_realisasi_pengajuan', [
                            'role' => $role,
                            'status' => $status,
                            'start_date' => $start_date,
                            'end_date' => $end_date,
        ...
        <tbody>
            ...
            @foreach ($data2 as $a)
                <tr>
                   ...
                   {{-- lpj --}}
                   <td onclick="window.open('/{{ $role }}/detail-pengajuan/{{ $a->id_pengajuan }}', '_blank');"  class="text-right" 
                    style=" cursor: pointer;">
...
<body>
                                ...
                                @foreach ($details->where('nama_program', $a->nama_program) as $b)
                                    <tr style=" page-break-inside: avoid;">
                                        ...
                                        <td style="width: 18%;vertical-align:middle; text-align:center;">
                                            <b>RTG {{ strtoupper(app\Http\Controllers\PengajuanController::get_nama_ranting($b->id_ranting)) }}</b><br>{{ app\Http\Controllers\PengajuanController::get_nama_bmt($b->id_rekening) }}<br>({{ app\Http\Controllers\PengajuanController::no_rekening($b->id_rekening) }})
                                        </td>
                                        @php
    ...
    <div class="table-responsive card card-body">
            ...
            <div>
                <div class="btn btn-group btn-block p-0 m-0" role="group">
                    ...
                    <div class="dropdown-menu btn-block" style="border-radius: 10px">
                        ...
                        <a class="dropdown-item btn-block" target="_blank"
                            href="{{ route('pdf_umum_ranting_realisasi_penerima_manfaat', [
                                'role' => $role,
                                'status' => $status,
                                'start_date' => $start_date,
                                'end_date' => $end_date,
                        ...
                        <a class="dropdown-item btn-block" target="_blank"
                        href="{{ route('excel_umum_ranting_realisasi_penerima_manfaat', [
                            'role' => $role,
                            'status' => $status,
                            'start_date' => $start_date,
                            'end_date' => $end_date,
        ...
        <table class="table table-bordered table-hover" id="Ranting2" style="width:100%">
            <thead>
                <tr class="text-center ">
                    <th style="width: 3%;vertical-align:middle;text-align:center"> NO
                    </th>
                ...
                @foreach ($penerima_manfaat_ranting as $p_manfaat_ranting)
                    <tr>
                        ...
                        <td   
                            class="text-bold" style=" cursor: pointer;text-align:center;padding-top:3mm;">
                            {{ $loop->iteration }}</td>
                            <td>{{ Carbon\Carbon::parse($p_manfaat_ranting->tgl_bantuan)->isoFormat('D/M/Y') }}</td>
                            <td><b style="font-size:16px;">{{ $p_manfaat_ranting->nama }} </b><br>
                                NIK : {{ $p_manfaat_ranting->nik }} <br> 
                                KK : {{ $p_manfaat_ranting->nokk }} <br>  
                               NO HP :  {{ $p_manfaat_ranting->nohp }} 
                            </td>
                            <td>{{ $p_manfaat_ranting->alamat }}</td>
                            <td>Rp{{ number_format($p_manfaat_ranting->nominal_bantuan, 0, '.', '.') }},-</td>  
                            <td>{{ $p_manfaat_ranting->nama_asnaf }}</td>
                            <td>{{ $p_manfaat_ranting->jenis_bantuan }}</td>
                            <td>{{ $p_manfaat_ranting->pilar }}</td>
                            <td>{{ $p_manfaat_ranting->nama_program }}</td>
                ...
                <div class="card p-3 mt-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="text-bold">
                                {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('program', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            </span>
                        </div>
                        <div class="col-md-6">
                            <em>Total Penerima</em><br>
                            <span class="text-bold">
                                {{ App\Http\Controllers\ChartLaporan::getStatisticPengajuan('penerima', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }}
                            </span>
                        </div>
                        <div class="col-md-6">
                            <em>Total Dapat Dicairkan</em><br>
                            <span class="text-bold text-warning">
                                Rp{{ number_format(App\Http\Controllers\ChartLaporan::getStatisticPengajuan('dicairkan', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2), 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        new Chart(ctxRanting, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        // penguat kelembagaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2 , $status_lpj2) }},
                        // ekonomi
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2 , $status_lpj2) }},
                        // pendidikan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2 , $status_lpj2) }},
                        // kesehatan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2 , $status_lpj2) }},
                        // dakwah kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2 , $status_lpj2) }},
                        // kemanusiaan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2 , $status_lpj2) }},
                        // lingkungan
                        {{ App\Http\Controllers\ChartLaporan::getTotalByPilar('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2 , $status_lpj2) }},
                    ]
                }, ]
            },
            options: {
    ...
    new Chart(ctxRantingNom, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [
                    // penguat kelembagaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '9e2ea277-9550-4ff7-bd6a-5fb36ef30633', $start_date2, $end_date2, $status_lpj2) }},
                    // ekonomi
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '30746c18-3f7a-4736-ae47-ea91154a5a00', $start_date2, $end_date2, $status_lpj2) }},
                    // pendidikan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'e47c6722-98b5-42b9-9b37-22f7b8437450', $start_date2, $end_date2, $status_lpj2) }},
                    // kesehatan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, '2a700a8d-dd49-46d3-9e25-2953266cf9a5', $start_date2, $end_date2, $status_lpj2) }},
                    // dakwah kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'cde8bd7b-7467-40c5-a92a-957a8176aed9', $start_date2, $end_date2, $status_lpj2) }},
                    // kemanusiaan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'ce2ac72c-02bc-4d8c-b143-9d526b1edd2b', $start_date2, $end_date2, $status_lpj2) }},
                    // lingkungan
                    {{ App\Http\Controllers\ChartLaporan::getTotalByNominal('ranting', $id_upzis2, $id_ranting2, 'd578e2e4-23d4-4cc6-9657-2415ba633420', $start_date2, $end_date2, $status_lpj2) }},
                ]
            }, ]
        },
        options: {
