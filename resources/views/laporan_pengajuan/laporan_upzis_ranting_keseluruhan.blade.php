@extends('main')
    ...
    @section('lap_upzis_ranting_keseluruhan', 'active')
                        ...
                        <div class="row mt-2 mr-2 ml-2 card-header-data-pengajuan">
                            <div class="col-12 col-md-12 col-sm-12 mb-2 mb-xl-0 pl-2">
                                <h5 class="d-flex justify-content mt-2">
                                    <b class="text-success pl-2 mt-1">DATA {{ strtoupper($sub) }} PER WILAYAH 
                                    @if($id_upzis2)
                                    KECAMATAN : {{ strtoupper(app\Http\Controllers\PengajuanController::get_nama_upzis($id_upzis2)) }}
                                    @else 
                                      KECAMATAN : SEMUA
                                     @endif
                                </b>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content " id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="ranting" role="tabpanel"
                                    ...
                                    @include('laporan_pengajuan.tab_laporan_upzis_ranting_keseluruhan')
                                </div>
