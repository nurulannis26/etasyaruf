...
@else
    @section('lap_internalpc_pc', 'active')
        ...
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-6 text-secondary mt-1">
                    ...
                    <a> Data {{ ucfirst($sub) }} Lazisnu Cilacap</a>
                </div>
                            ...
                            <div class="tab-content " id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $act_tab_filter_internal_1 }}" id="internal" role="tabpanel"
                                    ...
                                    @if ($filter_internal == 'on')
                                        <livewire:laporan-internal-pc :c_filter_daterange="$c_filter_daterange" :c_filter_status="$c_filter_status"
                                            :c_filter_tujuan="$c_filter_tujuan" :filter_internal="$filter_internal" :sub="$sub">
                                        @elseif($filter_internal == '')
                                            <livewire:laporan-internal-pc :filter_internal="$filter_internal" :sub="$sub">
                                    @endif
                                </div>
                                {{-- end internal pc --}}
                                ...
                                <div class="tab-pane fade {{ $act_tab_filter_pc_umum_1 }}" id="pc" role="tabpanel"
                                    ...
                                    @if ($filter_pc_umum == 'on')
                                        <livewire:laporan-umum-pc :c_filter_daterange2="$c_filter_daterange2" :c_filter_status="$c_filter_status"
                                            :c_filter_kategori="$c_filter_kategori" :c_filter_pilar="$c_filter_pilar" :filter_pc_umum="$filter_pc_umum" :sub="$sub">
                                        @elseif($filter_pc_umum == '')
                                            <livewire:laporan-umum-pc :filter_pc_umum="$filter_pc_umum" :sub="$sub">
                                    @endif
                                </div>
                                {{-- end internal pc --}}
