   {{--  tambah pilar --}}
   <div wire:ignore.self class="modal fade" id="modal_umum_penggunaan_dana" data-backdrop="static" tabindex="-1"
       ...
       <div class="modal-dialog modal-lg">
           <div class="modal-content">
               ...
               <form wire:submit.prevent="tambah_umum_penggunaan_dana">
                   <div class="modal-body">
                       <div class="form-row">
                           ...
                           <div class="form-group col-md-6 intro-dana_pengjuanz">
                               ...
                               <span style="color:rgba(230, 82, 82)">*</span>
                               <select wire:model="opsi_dana" class="form-control">
                           ...
                           <div class="form-group col-md-6 intro-dibayarkan">
                               ...
                               <div class="custom-file custom-file-lampiran">
                                   <input type="file" wire:model="foto_kegiatan"
                                       accept="application/pdf, image/png, image/jpg, image/jpeg"
                                       class="custom-file-input" id="file" name="foto_kegiatan">
                                   <label class="custom-file-label" for="customFile">Pilih
                                       file</label>
                               </div>
                           </div>
                           <div class="form-group col-md-12 intro-keterangan">
                               ...
                               <span style="color:rgba(230, 82, 82)">*</span>
                               <textarea type="text" class="form-control " wire:model="keterangan_lpj" placeholder="Masukan keterangan penggunaan dana"
                                   rows="2"></textarea>
                           </div>
                   ...
                   <div class="modal-footer">
                       <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>
                           Batal</button>
                       @if ($tgl_penggunaan_dana == '' or $dibayarkan_kepada == '' or $nominal == '' or $nota == '' or $keterangan_lpj == '')
