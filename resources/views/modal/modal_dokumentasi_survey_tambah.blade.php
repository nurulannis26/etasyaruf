   {{--  tambah pilar --}}
   <div wire:ignore.self class="modal fade" id="modal_dokumentasi_survey_tambah" data-backdrop="static" tabindex="-1"
   data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title">TAMBAH DOKUMENTASI SURVEY
                   </h5>
                   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                       <span aria-hidden="true">&times;</span>
                   </button>
               </div>
               <form wire:submit.prevent="tambah_dokumentasi_survey">
                   <div class="modal-body form-row">
                       ...
                       <div class="form-group col-md-6">
                           ...
                           <input wire:model="judul_dokumentasi_survey" type="text" class="form-control" name="judul"
                       ...
                       <div class="form-group col-md-6">
                           ...
                           <div class="custom-file custom-file-dokumentasi_survey">
                               <input type="file" wire:model="file_dokumentasi_survey"
                   ...
                   <div class="modal-footer">
                       <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>
                           Batal</button>
                       @if ($file_dokumentasi_survey == '' or $judul_dokumentasi_survey == '')
        ...
        $(document).ready(function() {
            ...
            window.loadContactDeviceSelect2 = () => {
                ...
                $('.tombol-tambah').click(function() {
                    $(".custom-file-dokumentasi_survey").html('').change();
                });
