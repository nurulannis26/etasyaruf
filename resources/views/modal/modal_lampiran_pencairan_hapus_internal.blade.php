<div wire:ignore.self class="modal fade" id="modal_lampiran_pencairan_hapus_internal" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="hapus_lampiran_pencairan_internal()" class="btn btn-danger close-modal"
