   {{--  tambah pilar --}}
   <div wire:ignore.self class="modal fade" id="modal_lampiran_pencairan_tambah_internal" data-backdrop="static" tabindex="-1"
   data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg">
           <div class="modal-content">
               ...
               <form wire:submit.prevent="tambah_lampiran_pencairan_internal">
