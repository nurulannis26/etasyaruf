                        ...
                        @else
                            <style>
                                ...
                                <div class="btn-group col-md-3 mt-3">
                                    <button wire:click="hapus_dokumentasi" class="btn btn-outline-danger custom-btn"
                                        type="button" wire:loading.attr="disabled">
                                        <i class="fas fa-trash"></i> Hapus
                                    </button>
                                    @if ($judul_dokumentasi == '')
                                        <button wire:click="cetak_dokumentasi" class="btn btn-outline-primary custom-btn"
                                        type="button" disabled wire:loading.attr="disabled">
                                    ...
                                    @endif
                                    @if ($judul_dokumentasi == '')
                                        <button class="btn btn-outline-success custom-btn" type="button" disabled wire:loading.attr="disabled">
                                            <i class="fas fa-edit"></i> Ubah
                                        </button>
                                    @else
                                        <button type="submit" name="submit" class="btn btn-outline-success custom-btn" type="button"
                                            wire:loading.attr="disabled">
                                            <i class="fas fa-edit"></i> Ubah
                                        </button>
                                    @endif
