                                    ...
                                    <div class="card-body modal-detail-rencana-pentasyarufan">
                                        ...
                                        <div class="collapse mt-1" id="detailPenerimaManfaatLpj" wire:ignore.self>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    @if ($data->status_rekomendasi == 'Sudah Terbit')
                                                        @if (Auth::user()->gocap_id_pc_pengurus && Auth::user()->gocap_id_pc_pengurus == '9f14046b-a733-4ef8-a3a4-db8185a889e8')
                                                            <a wire:click="" data-toggle="modal"
                                                                data-target="#hapus-semua-penerima"
                                                                aria-expanded="false"
                                                                aria-controls="deleteSemuaPenerima" href="#"
                                                                class="btn btn-sm btn-outline-danger hover">
                                                                <i class="fas fa-trash"></i> Hapus Semua
                                                            </a>
                                                        @endif
                                                    @else
                                                        <a wire:click="" data-toggle="modal"
                                                            data-target="#hapus-semua-penerima" aria-expanded="false"
                                                            aria-controls="deleteSemuaPenerima" href="#"
                                                            class="btn btn-sm btn-outline-danger hover">
                                                            <i class="fas fa-trash"></i> Hapus Semua
                                                        </a>
                                                    ...
                                                    <a href="{{ route('import_penerima_manfaat', ['id_pengajuan_detail' => $data_detail->id_pengajuan_detail]) }}"
                                                        target="_blank" class="btn btn-sm btn-outline-primary hover">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a wire:click="detail_lampiran('{{ $a->id_pengajuan_penerima }}')"
                                                                                    ...
                                                                                    class="dropdown-item"
                                                                                    href="#">Lampiran</a>
                                                                                @if ($data_detail and $data->status_rekomendasi == 'Sudah Terbit' and $data_detail->status_berita != 'Sudah Diperiksa')
                                                ...
                                                <tbody>
                                                    @forelse($data_lampiran_berita as $a)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{ asset('uploads/lampiran_berita/' . $a->file)}}"
