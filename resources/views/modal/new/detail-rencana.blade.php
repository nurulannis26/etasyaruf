                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @else
                                            @if (Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8c5a0ce3-540f-11ed-abf5-e4a8df91d8b3' 
                                                or Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8e2ba55e-725b-11ed-ad27-e4a8df91d8b3' )
                        ...
                        <div class="card">
                            <div class="card-body modal-detail-rencana-pentasyarufan">
                                ...
                                <div class="collapse" id="penerimaManfaat" wire:ignore.self>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="ml-auto">
                                            @if ($data_detail and $data->status_rekomendasi == 'Belum Terbit')
                                            ...
                                            <table class="table table-bordered mt-3" style="width:100%">
                                                <thead>
                                                    <tr class="text-center">
                                                        ...
                                                        @if ($data_detail and Auth::user()->gocap_id_pc_pengurus != null and $data->status_rekomendasi == 'Belum Terbit')
                                                ...
                                                <div class="card p-3 hover">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            ...
                                                            <span class="text-bold">Kepala Cabang -
                                                                {{ \App\Http\Controllers\Helper::getDataPengurusByJabatan('pc', 'Kepala Cabang')->nama ?? null }}</span><br>
                                                        </div>
                                                        <div class="col-md-4">
                                ...
                                <div class="collapse" id="pencairan2" wire:ignore.self>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="ml-auto">
                                            @if (
                                                $data_detail and
                                                    Auth::user()->gocap_id_pc_pengurus != null and
                                                    Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '3b5ce3c4-a045-11ed-a0ac-040300000000' and $data_detail->approval_status == 'Disetujui')
                                                <div class="dropdown float-right">
                                                    <button
                                                        class="btn btn-outline-secondary btn-sm dropdown-toggle hover"
                                                        type="button" id="dropdownMenu2" data-toggle="dropdown"
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        ...
                                                        @if ($data_detail->pencairan_status == 'Berhasil Dicairkan' or $data_detail->pencairan_status == 'Ditolak')
                                                            <button class="dropdown-item" wire:click="batalRespon()">
                                                                <i class="fa fa-undo"></i> Batalkan Respon
                                                            </button>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    @if (
                                        ...
                                        <div class="callout callout-danger mt-2">
                                            ...
                                            <p class="mt-1">Program belum disetujui Kepala Cabang</p>
                                        </div>
                                    @endif
                                    {{-- acc pencairan --}}
                                    <div class="collapse" id="pencairan" wire:ignore.self>
                                        <div class="card card-body mt-3">
                                            ...
                                            <form wire:submit.prevent="pencairan">
                                                <div class="form-row mt-1">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input wire:model="satuan_pencairan" id="satuan_pencairan" wire:input="updateTotal3"
                                                                type="text" value="" class="form-control"
                                                                placeholder="Masukan Nominal Satuan">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label for="inputNama">JUMLAH PENERIMA DISETUJUI
                                                            &nbsp;</label>
                                                        <sup class="badge badge-danger text-white mb-2"
                                                            style="background-color:rgba(230,82,82)">WAJIB</sup>
                                                        <div class="input-group">
                                                            <input wire:model="jumlah_penerima_disetujui" wire:input="updateTotal3"
                                                                id="satuan_pencairan" type="text" value=""
                                                                class="form-control"
                                                                placeholder="Masukan Jumlah Disetujui">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text bor-abu">Penerima Manfaat</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- nominal pencairan --}}
                                                    <div class="form-group col-md-12">
                                                        <div class="d-flex">
                                                            <label for="inputNama">NOMINAL BISA DICAIRKAN (TOTAL)
                                                                &nbsp;</label>
                                                            <span class="ml-auto">
                                                                <em>({{ $this->jumlah_penerima_disetujui ?? null }}
                                                                    Penerima Manfaat)</em>
                                                            </span>
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input id="nominal" type="text" wire:model="nominal_pencairan"
                                                                class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                ...
                                                {{-- tombol cairkan --}}
                                                <div class="d-flex float-right">
                                                    @if ($id_rekening == '' or $satuan_pencairan == '')
