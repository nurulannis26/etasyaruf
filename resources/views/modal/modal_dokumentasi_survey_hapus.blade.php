<div wire:ignore.self class="modal fade" id="modal_dokumentasi_survey_hapus" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="hapus_dokumentasi_survey()" class="btn btn-danger close-modal"
