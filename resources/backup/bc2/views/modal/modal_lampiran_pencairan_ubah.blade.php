   {{--  tambah pilar --}}
   <div wire:ignore.self class="modal fade" id="modal_lampiran_pencairan_ubah" data-backdrop="static" tabindex="-1"
       ...
       <div class="modal-dialog modal-lg">
           <div class="modal-content">
               ...
               <form wire:submit.prevent="ubah_lampiran_pencairan">
