<div wire:ignore.self class="modal fade" id="modal_pengajuan_penerima_manfaat_hapus2" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="hapus_penerima()" class="btn btn-danger close-modal"
