@if (Auth::user()->gocap_id_pc_pengurus != null)
    ...
    <div wire:ignore.self class="modal fade" id="modal_pengajuan_penerima_manfaat" data-backdrop="static" tabindex="-1"
                        ...
                        <div class="form-row">
                            ...
                            @if ($data_detail->sumber_dana == 'Dana Infak')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <sup class="badge badge-danger text-white mb-2"
                                        style="background-color:rgba(230,82,82)">WAJIB</sup>
                                    <input value=" {{ $this->nama_pilar($data_detail->id_program_pilar) }}"
                                        type="text" class="form-control" disabled placeholder="Miskin">
                                </div>
                                {{-- end NAMA PENERIMA MANFAAT --}}
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <sup class="badge badge-danger text-white mb-2"
                                        style="background-color:rgba(230,82,82)">WAJIB</sup>
                                    <input value="{{ $this->nama_kegiatan($data_detail->id_program_kegiatan) }}"
                                        type="text" class="form-control" placeholder="Masukkan Kegiatan" readonly>
                                </div>
                                {{-- end NAMA PENERIMA MANFAAT --}}
