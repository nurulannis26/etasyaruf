{{--  tambah pilar --}}
<div wire:ignore.self class="modal fade" id="modal_pengeluaran_ubah" data-backdrop="static" tabindex="-1"
    data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">UBAH PENYALURAN
                </h5>
            ...
            <div class="modal-body">
                ...
                <form wire:submit.prevent="ubah_pengeluaran">
                    <div class="form-row">
                        {{-- judul pengeluaran --}}
                        <div class="form-group col-md-8">
                            <label for="inputTempat">JUDUL PENGELUARAN &nbsp;</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputTempat">TGL PENGELUARAN &nbsp;</label>
                            <sup class="badge badge-danger text-white mb-2"
                                style="background-color:rgba(230,82,82)">WAJIB</sup>
                        ...
                        <div class="form-group col-md-2">
                            <label for="inputTempat">JUMLAH &nbsp;</label>
                            <sup class="badge badge-danger text-white mb-2"
                                style="background-color:rgba(230,82,82)">WAJIB</sup>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" wire:model="nominal_pengeluaran"
                                    placeholder="Masukan nominal pengeluaran" id="nominal_pengeluaran2">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>
                    Batal</button>
                @if ($judul_pengeluaran == '' or $tgl_pengeluaran == '' or $jumlah_pengeluaran == '' or $nominal_pengeluaran == '')
                    <button class="btn btn-success" disabled wire:loading.attr="disabled"><i class="fas fa-save"></i>
