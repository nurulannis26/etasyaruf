...
<div>
    <table style="width: 100%; font-size: 11pt; border: 1px solid black; margin: auto;">
        ...
        <tr>
            <td style="border: 1px solid black;width: 6%; text-align:center;">7</td>
...
<table>
    ...
    <tr>
        <td style="text-align: center;width:50%;"><u>Ahmad Fauzi, S.Pd.I</u></td>
        <td style="text-align: center;width:50%;"><u>Mu'afah, S.E</u></td>
    </tr>

    <tr>
        <td style="text-align: center;width:50%;">Direktur NU Care LAZISNU Cilacap</td>
        <td style="text-align: center;width:50%;">Staf Administrasi dan Program</td>
    </tr>
    ...
    <tr>
        <td colspan="2" style="text-align: center; widht:100%;"><u>H. Wasbah Samudra Fawaid, S.E </u></td>
    </tr>


    <tr>
        <td colspan="2" style="text-align: center; widht:100%;">Ketua NU Care LAZISNU Cilacap</td>
    </tr>
