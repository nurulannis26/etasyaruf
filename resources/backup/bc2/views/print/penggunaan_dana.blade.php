...
<head>
    <title>{{ str_replace('/', '_', $internal->nomor_surat) . '_PENGGUNAAN_DANA' }}</title>
        ...
        <table cellpadding="0" cellspacing="0"
            ...
            <tr style=" border: 1px solid black;background-color:">
                ...
                <td colspan="2"
                    ...
                    {{ App\Http\Controllers\PrintController::nama_pengurus_pc($internal->maker_tingkat_pc) }}
                </td>
            </tr>
            ...
            <tr style=" border: 1px solid black;background-color:">
                ...
                <td colspan="2"
                    style="width: 80%;padding-left:2mm;vertical-align:middle;text-align:left; border: 1px solid black;">
                    {{ Carbon\Carbon::parse($internal->tgl_pencairan)->isoFormat('D MMMM Y') }}
                </td>
            </tr>
            ...
            <tr style=" border: 1px solid black;background-color:">
                ...
                <td colspan="2"
                    style="width: 80%;padding-left:2mm;vertical-align:middle;text-align:left; border: 1px solid black;">
                    Rp {{ number_format($internal->nominal_pencairan, 0, '.', '.') }},-
                </td>
            </tr>
            <tr style=" border: 1px solid black;background-color:">
                <td
