                    ...
                    <div class="input-group ">
                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                            <select onchange="submitFormRanting()" name="status2" class="form-control select2"
                                ...
                                <option value="Sudah Terbit Rekom" {{ $status2 == 'Sudah Terbit Rekom' ? 'selected' : '' }}>Sudah Terbit Rekom
                                </option>
                                <option value="Belum Terbit Rekom" {{ $status2 == 'Belum Terbit Rekom' ? 'selected' : '' }}>Belum Terbit Rekom
                                </option>
                            </select>
                        @else
                            <select onchange="submitFormRanting()" name="status2" class="form-control select2"
