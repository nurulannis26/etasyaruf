...
<div class="card intro-card-data-pengajuan">
    <div class="card-body ">
                    ...
                    <div class="input-group ">
                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                            <select onchange="submitFormRanting()" name="status2" class="form-control select2"
                                ...
                                <option value="Diajukan" {{ $status2 == 'Diajukan' ? 'selected' : '' }}>Semua Status Rekom
                                <option value="Sudah Terbit" {{ $status2 == 'Sudah Terbit' ? 'selected' : '' }}>Sudah Terbit Rekom
                                </option>
                                <option value="Belum Terbit" {{ $status2 == 'Belum Terbit' ? 'selected' : '' }}>Belum Terbit Rekom
                                </option>
                            </select>
                        @else
                            <select onchange="submitFormRanting()" name="status2" class="form-control select2"
        ...
        <div class="form-row">
            {{-- info --}}
            <div class="col-12 {{ auth::user()->gocap_id_pc_pengurus != null ? 'col-md-9' : 'col-md-10' }} col-md-9 col-sm-12 mb-xl-0">
                <div class="d-flex flex-row bd-highlight align-items-center">
                    <div class="p-1 bd-highlight">
                        <i class="fas fa-info-circle"></i>
                    </div>
            ...
            @if (Auth::user()->gocap_id_pc_pengurus != null)
                <div class="col-12 col-md-1 col-sm-12 mb-2 mb-xl-0">
                    <a class="btn btn-light border-grey hover btn-block tombol-reset-pc" href="/{{ $role }}/upzis-ranting">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_total', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Program)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_dalam_proses', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_dalam_proses', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    @endforeach
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_terbit_rekom', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('sudah_lpj', 'ranting', $id_upzis2, $id_ranting2, $start_date2, $end_date2, $status2) }} Program Sudah LPJ</div>
