...
<head>
    <title>REKAP_PENGAJUAN_PENTASYARUFAN_TINGKAT_PRNU @if ($ranting == 'Semua')
            _
        @else
            {{ '_' . strtoupper(App\Http\Controllers\PrintPengajuanController::nama_ranting($ranting)) . '_' }}
    ...
    <div>
        ...
        <body>
                    ...
                    <tr>
                        <td colspan="5" style="100%; padding-right:5.4pt; padding-left:5.4pt; vertical-align:top;">
                            ...
                            <p
                                ...
                                <strong><span> REKAP PENGAJUAN PENTASYARUFAN TINGKAT PRNU @if ($ranting != 'Semua')
                                            {{ strtoupper(App\Http\Controllers\PrintPengajuanController::nama_ranting($ranting)) }}
                                        @endif
                                    </span></strong>
                            </p>
                            <p
            ...
            <table style="width: 100%;font-size:11pt;">
                ...
                <tr>
                    <td style="width: 12%"> <b>PRNU</b></td>
                    <td style="width: 1%">:</td>
                    <td style="width: 60%">
                        @if ($ranting == 'Semua')
                            Semua
                        @else
                            {{ App\Http\Controllers\PrintPengajuanController::nama_ranting($ranting) }}
                        @endif
                    </td>
                </tr>
                        ...
                        @foreach ($daftar_ranting as $a)
                            <tr style="background-color:#cbf2d6;border-bottom: 1px solid black;">
                                ...
                                <td style="padding-left:1mm;text-align:center">
                                    <b>{{ App\Http\Controllers\PrintPengajuanController::hitung_jumlah_rencana_per_ranting($a->id_upzis, $a->id_ranting, $bulan, $tahun, $status) }}
                                    </b>
                                </td>
                                <td style="padding-left:1mm;text-align:center">
                                    <b>{{ App\Http\Controllers\PrintPengajuanController::hitung_jumlah_penerima_per_ranting($a->id_upzis, $a->id_ranting, $bulan, $tahun, $status) }}
                                    </b>
                                </td>
                                ...
                                <td style="padding-left:1mm;padding-right:1mm;vertical-align: top;">
                                    ...
                                    <span style="float:right;"><b>
                                            {{ number_format(App\Http\Controllers\PrintPengajuanController::hitung_nominal_pengajuan_per_ranting($a->id_upzis, $a->id_ranting, $bulan, $tahun, $status), 0, '.', '.') }},-</b></span>
                                </td>

                                <td style="padding-left:1mm;padding-right:1mm;vertical-align: top;">
                                    <span><b>Rp</b></span>
                                    <span style="float:right;"><b>
                                            {{ number_format(App\Http\Controllers\PrintPengajuanController::hitung_nominal_disetujui_per_ranting($a->id_upzis, $a->id_ranting, $bulan, $tahun, $status), 0, '.', '.') }},-</b></span>
                                </td>
