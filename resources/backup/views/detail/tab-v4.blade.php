...
<div class="row">
    ...
    @if (Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8c5a0ce3-540f-11ed-abf5-e4a8df91d8b3')
        ...
        <div class="card card-body mt-3 mr-2 ml-2" style="display: {{ $none_block_acc_direktur_keuangan }};">
            <div class="d-flex justify-content-between align-items-center">
                <b class="text-success">ACC PENCAIRAN DIREKTUR</b>
        ...
        <div class="card card-body mt-3 mr-2 ml-2" style="display: {{ $none_block_tolak_direktur_keuangan }};">
            <div class="d-flex justify-content-between align-items-center">
                <b class="text-danger">TOLAK PENCAIRAN DIREKTUR</b>
                <a wire:click="close" type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </a>
            </div>
                    ...
                    <div class="form-group col-md-12">
                        <div class="input-group" wire:ignore>
                                ...
                                <select wire:model="id_rekening2" class="form-control" id="inptKabupaten">
                                    <option selected value="{{ $rek_cek->id_rekening ?? '' }}">
                                        {{ $rek_cek->nama_rekening ?? '' }} -
                                        {{ $rek_cek->no_rekening ?? '' }}
                                        - Rp{{ number_format($rek_cek->saldo ?? 0, 0, '.', '.') }}
                                    </option>
                                    @foreach ($rekening_keuangan as $ab)
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 tab-persetujuan_direktur-detail-umum-pc">
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
            <div>
                <i class="fas fa-clipboard-check "></i><b> PERSETUJUAN DIREKTUR </b>
            ...
            @if (Auth::user()->gocap_id_pc_pengurus != null)
                ...
                @if (
                    ($data_detail->approval_status == 'Disetujui' &&
                        $dp->status_survey == 'Diajukan' &&
                        $data_detail->approval_status_pencairan_direktur != 'Disetujui') ||
                        ($data_detail->approval_status == 'Disetujui' &&
                            $data_detail->pil_survey == 'Tidak Perlu' &&
                            $data_detail->approval_status_pencairan_direktur != 'Disetujui'))
            ...
            @if ($this->cek_survey($id_pengajuan) == 'Perlu')
                ...
                @if (Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8c5a0ce3-540f-11ed-abf5-e4a8df91d8b3' and ($data_detail->approval_status == 'Belum Direspon' or $data_detail->approval_status == 'Ditolak') and $survey != null)
                    <div class="mr-2">
                        <div class="btn-group float-right">
                ...
                @endif
            @else
                @if (Auth::user()->PcPengurus->JabatanPengurus->id_pengurus_jabatan == '8c5a0ce3-540f-11ed-abf5-e4a8df91d8b3' and ($data_detail->approval_status == 'Belum Direspon' or $data_detail->approval_status == 'Ditolak'))
                    <div class="mr-2">
                        <div class="btn-group float-right">
        ...
        <div class="col-12 mt-2">
            ...
            <table class="table table-bordered mt-2">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                @if ($data_detail->denial_note_pencairan_direktur == null)
                                    -
                                @else
                                    {{ Carbon\Carbon::parse($data_detail->denial_note_pencairan_direktur)->isoFormat('dddd, D MMMM Y') }}
                                @endif
                            </td>
                        </tr>
                        {{-- end tanggal ditolak --}}
                ...
                <td style="vertical-align: middle;">
                    ...
                    @php
                        $rek_dir = App\Models\Rekening::where('id_rekening', $data_detail->id_rekening_pencairan_direktur)->first();
                    @endphp
                    {{-- {{ dd($data_detail->id_rekening) }} --}}
                    @if ($data_detail->id_rekening_pencairan_direktur)
                        <tr>
                            <td>
                                <b style="font-size: 12pt;">Rekening</b>
                            </td>
                            <td>
                                {{ $rek_dir->nama_rekening ?? ('' . ' - ' . $rek_dir->no_rekening ?? '') }}
                            </td>
                        </tr>
                    @else
                        <tr>
                        ...
                        @if ($data_detail->approval_status == 'Disetujui' or $data_detail->approval_status == 'Belum Direspon')
                            ...
                            <td style="vertical-align: middle;">
                                ...
                                @else
                                    ...
                                    <br>
                                    <span
                                        style="font-size:11pt;">({{ $this->jabatan_pengurus_pc($data_detail->approval_pencairan_direktur_id) }}
                        ...
                        @elseif($data_detail->approval_status == 'Ditolak')
                            ...
                            <td style="vertical-align: middle;">
                                ...
                                @else
                                    ...
                                    <br>
                                    <span
                                        style="font-size:11pt;">({{ $this->jabatan_pengurus_pc($data_detail->denial_pencairan_direktur_id) }}
                                        - {{ $this->nama_pc($data->id_pc) }})</span>
                                @endif
                            </td>
                        @endif
            ...
            @if ($data_detail->approval_status_pencairan_direktur == 'Disetujui')
                @if (Auth::user()->gocap_id_pc_pengurus == $data_detail->staf_keuangan_pc)
                    @if ($data_detail->pencairan_status == 'Belum Dicairkan')
                        ...
                        @if ($data_detail->approval_status == 'Belum Direspon' or $data_detail->approval_status == 'Ditolak')
                            <div class="mr-2">
                                <div class="btn-group float-right">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($data_detail->pencairan_status == 'Ditolak')
                                -
                            @else
                                {{ $this->nama_rekening($data_detail->id_rekening) ?? '' }}
                            @endif
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            ...
                            @else
                                ...
                                <br>
                                <span
                                    style="font-size:11pt;">({{ $this->jabatan_pengurus_pc($data_detail->dicairkan_kepada) }}
                                    - {{ $this->nama_pc($data->id_pc) }})</span>
                            @endif
                        </td>
                    </tr>
