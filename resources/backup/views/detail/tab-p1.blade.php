  ...
  <div class="modal-body">
      <div class="form-row">
          ...
          @if ($this->opsi_pemohon == 'Individu')
              ...
              {{-- alamat --}}
              <div class="form-group col-md-12 modal-tambah-pengajuan-alamat-pemohon-pengajuan-panduan">
          ...
          @elseif ($this->opsi_pemohon == 'Entitas')
              ...
              <div class="form-group col-md-6">
                  <label>NO HP &nbsp;</label>
                  {{-- <sup class="badge badge-danger text-white mb-2" style="background-color:rgba(230,82,82)">WAJIB</sup> --}}
                  <input wire:model="no_hp_entitas" type="text" class="form-control" placeholder="Masukan No HP">
              </div>
        @elseif ($this->opsi_pemohon == 'Internal')
          ...
          {{-- end program --}}
          <hr>
          @if (empty($this->sumber_dana))
              <div class="form-group col-md-6">
                  <label for="inputAlamat">ASNAF / PILAR &nbsp;</label>
                  {{-- <sup class="badge badge-danger text-white mb-2" style="background-color:rgba(230,82,82)">WAJIB</sup> --}}
                  <input type="text" class="form-control" disabled placeholder="Pilih Asnaf / Pilar dahulu">

              </div>
              <hr>
          @elseif ($this->sumber_dana == 'Dana Zakat')
              {{-- program --}}
              <div class="form-group col-md-6">
