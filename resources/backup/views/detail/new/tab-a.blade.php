         ...
         <thead>
             <tr class="text-center">
                 ...
                 <th style="width: 5%;vertical-align:middle;"> 
                    <i class="fas fa-info-circle tooltip-icon" data-toggle="tooltip" data-placement="top" style="cursor: pointer;"
                    title="Jenis Penerima Manfaat By Warna <br/>
                    1. Hitam = Jumlah Penerima Diajukan <br/> 2. Biru = Jumlah Penerima Tersalurkan" data-html="true"></i>
                    <br>
                    JUMLAH<br>
                    PENERIMA<br>
                    MANFAAT 
                  ...
                  <th style="width: 10%;vertical-align:middle;"> 
                    ...
                    1. Hitam = Nominal Diajukan <br/> 2. Hijau = Nominal Disetujui <br/> 3. Kuning = Nominal Dapat Dicairkan" data-html="true"></i>
                    <br>
                  ...
                  <th style="width: 10%;vertical-align:middle;"> 
                    ...
                    4. Biru = Nominal Disalurkan" data-html="true"></i>
                    <br>
                    NOMINAL TOTAL
                  </th>
             ...
             @foreach ($rencana_a as $a)
                 <tr data-toggle="collapse" href="#collapseExample{{ $a->id_pengajuan_detail }}" role="button"
                     ...
                     <td><b style="font-size: 12pt">{{ $a->nama_program }}</b>
                         <br>
                         <em style="font-size: 12pt;">{{ \App\Http\Controllers\Helper::getDataPilar($a->id_program_pilar ?? null)->pluck('pilar')->first() }}</em>
                         <br>
                         @if ($data->status_pengajuan == 'Direncanakan')
                     ...
                     <td class="text-center">
                        ...
                        <div class="collapse" id="collapseExample{{ $a->id_pengajuan_detail }}" wire:ignore.self>
                            <span style="font-size:11pt;" class="text-bold text-primary">
                                {{ $this->getJumlahPenerimaPenyaluran($a->id_pengajuan_detail) }}</span>
                     ...
                     <td class="text-right">
                         ...
                         <div class="collapse" id="collapseExample{{ $a->id_pengajuan_detail }}" wire:ignore.self>
                             ...
                             <span style="font-size:11pt;" class="text-bold text-warning">
                                 ...
                                 <br>
                                 <span style="font-size:11pt;" class="text-bold text-primary">
                                    {{ $this->numberFormat($this->getNominalPenyaluran($a->id_pengajuan_detail)) }}</span>
                         </div>
                     </td>
                     <td class="text-center">
             ...
             @foreach ($rencana_b as $b)
                 <tr data-toggle="collapse" href="#collapseExample{{ $b->id_pengajuan_detail }}" role="button"
                     ...
                     <td class="text-center">
                        ...
                        <div class="collapse" id="collapseExample{{ $b->id_pengajuan_detail }}" wire:ignore.self>
                            <span style="font-size:11pt;" class="text-bold text-primary">
                                {{ $this->getJumlahPenerimaPenyaluran($b->id_pengajuan_detail) }}</span>
             ...
             @if ($data->tingkat == 'Upzis MWCNU')
                 ...
                 @foreach ($rencana_c as $c)
                     <tr data-toggle="collapse" href="#collapseExample{{ $c->id_pengajuan_detail }}" role="button"
                         ...
                         <td class="text-center">
                            {{ $c->jumlah_penerima }}
                            <div class="collapse" id="collapseExample{{ $c->id_pengajuan_detail }}" wire:ignore.self>
                                <span style="font-size:11pt;" class="text-bold text-primary">
                                    {{ $this->getJumlahPenerimaPenyaluran($c->id_pengajuan_detail) }}</span>
