    ...
    <div class="card-body ">
                    ...
                    <div class="input-group ">
                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                            <select onchange="submitFormUpzis()" name="status" class="form-control select2"
                                ...
                                <option value="Sudah Terbit Rekom" {{ $status == 'Sudah Terbit Rekom' ? 'selected' : '' }}>Sudah Terbit Rekom
                                </option>
                                <option value="Belum Terbit Rekom" {{ $status == 'Belum Terbit Rekom' ? 'selected' : '' }}>Belum Terbit Rekom
                                </option>
                            </select>
                        @else
                            <select onchange="submitFormUpzis()" name="status" class="form-control select2"
        ...
        <div class="form-row">
            ...
            @if (Auth::user()->gocap_id_upzis_pengurus != null)
                <div class="col-12 col-md-2 col-sm-12  mb-xl-0">
                    <a href="#"
                        class="btn btn-block btn-outline-success hover
                        intro-ekspors-data-pengajuan">
                        <i class="fas fa-file-pdf"></i> Ekspor</a>
                </div>
            @endif
        </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_total', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_total', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_dalam_proses', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_dalam_proses', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_dalam_proses', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_terbit_rekom', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_terbit_rekom', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_terbit_rekom', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program)</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_sudah_lpj', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('sudah_lpj', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program Sudah LPJ</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_direncanakan', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_direncanakan', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_direncanakan', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program)</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        ...
                        @php
                            $nominal = App\Http\Controllers\Chart::getStatisticPengajuan('nominal_diajukan', 'upzis', $id_upzis, null, $start_date, $end_date, $status);
                        @endphp
                        <b> Rp. {{ number_format($nominal, 0, ',', '.') }},-</b>
                        {{-- <b> Rp. 230.000.000</b> --}}

                        <div class="h6 mb-0 mb-1" style="color: #28a745">
                            {{ App\Http\Controllers\Chart::getStatisticPengajuan('total_diajukan', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Pengajuan ({{ App\Http\Controllers\Chart::getStatisticPengajuan('program_diajukan', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }} Program)</div>
                ...
                <tr>
                    ...
                    <td onclick="window.open('/{{ $role }}/detail-pengajuan/{{ $a->id_pengajuan }}', '_blank');"
                       ...
                       <span class="text-bold" style="font-size: 13px">
                        ...
                        <br>
                        <div class="d-flex justify-content-between" style="font-size: 13px">                            <div>Pengajuan</div>
                            <div class="text-bold">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span class="text-bold">
                                {{ App\Http\Controllers\Chart::getStatisticPengajuan('total', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            </span>
                        </div>
                        <div class="col-md-6">
                            <em>Total Program</em><br>
                            <span class="text-bold">
                                {{ App\Http\Controllers\Chart::getStatisticPengajuan('program', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            </span>
                        </div>
                        <div class="col-md-6">
                            <em>Total Penerima</em><br>
                            <span class="text-bold">
                                {{ App\Http\Controllers\Chart::getStatisticPengajuan('penerima', 'upzis', $id_upzis, null, $start_date, $end_date, $status) }}
                            </span>
                        </div>
                        <div class="col-md-6">
                            <em>Total Dapat Dicairkan</em><br>
                            <span class="text-bold text-warning">
                                Rp{{ number_format(App\Http\Controllers\Chart::getStatisticPengajuan('dicairkan', 'upzis', $id_upzis, null, $start_date, $end_date, $status), 0, ',', '.') }}
                            </span>
                        </div>
                    </div>
                </div>
