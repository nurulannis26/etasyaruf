...
<p style="margin:0pt; text-align:center; font-size:11pt;">
    <b>REALISASI PENTASYARUFAN TINGKAT UPZIS</b>
    <br>
                ...
                @foreach ($uniquePrograms as $a)
                    ...
                    @foreach ($details->where('nama_program', $a->nama_program) as $b)
                        <tr style=" page-break-inside: avoid;">
                            ...
                            <td style="width: 18%;vertical-align:middle; border: 1px solid black; text-align:center;"><b>{{ strtoupper(app\Http\Controllers\PengajuanController::get_nama_upzis($b->id_upzis)) }}</b><br>{{ app\Http\Controllers\PengajuanController::get_nama_bmt($b->id_rekening) }}<br>({{ app\Http\Controllers\PengajuanController::no_rekening($b->id_rekening) }})
                            </td>
                            @php
