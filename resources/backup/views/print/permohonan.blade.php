        ...
        <tr>
            ...
            <table style="width: 100%;font-size:11pt;">
                ...
                <tr>
                    ...
                    <td style="width: 48%">@if ($data->tingkat == 'Upzis MWCNU')1. Kelembagaan (Rp{{ number_format($jumlah_nominal_a, 0, '.', '.') }}) <br>2. Sosial (Rp{{ number_format($jumlah_nominal_b, 0, '.', '.') }})<br>3. Operasional UPZIS (Rp{{ number_format($jumlah_nominal_c, 0, '.', '.') }})
                        @endif
                        @if ($data->tingkat == 'Ranting NU')1. Kelembagaan (Rp{{ number_format($jumlah_nominal_a, 0, '.', '.') }}) <br>2. Sosial (Rp{{ number_format($jumlah_nominal_b, 0, '.', '.') }})<br>
                        @endif
                    </td>
                </tr>
                <tr>
