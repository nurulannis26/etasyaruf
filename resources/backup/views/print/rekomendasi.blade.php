    ...
    <table style="width: 100%;font-size:11pt;">
        ...
        <tr>
            ...
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU')UPZIS MWCNU {{ App\Http\Controllers\Helper::getNamaUpzis($data->id_upzis) }} @else RANTING NU {{ App\Http\Controllers\Helper::getNamaRanting($data->id_ranting) }} @endif
            </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;font-size:11pt;">
        ...
        <tr>
            ...
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if($data->tingkat == 'Upzis MWCNU'){{App\Http\Controllers\Helper::getNamaPengurus('upzis', $data->pj_upzis)}}@endif @if($data->tingkat == 'Ranting NU'){{App\Http\Controllers\Helper::getNamaPengurus('ranting', $data->pj_ranting)}}@endif
            </td>
        </tr>
        @if ($tipe == 'bmt')
            <tr>
        ...
        <tr>
            ...
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU')@if ($tipe == 'bmt')Kelembagaan ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'LEMBAGA')->pluck('no_rekening')->first() ?? null }})
                   ...
                   <br>@if (App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first())Mobil Jenazah ({{ App\Http\Controllers\PrintController::getDataRekening3('upzis', $tipe, $data->id_upzis, 'MOBIL JENAZAH')->pluck('no_rekening')->first() ?? null }})
                    ...
                    <br><b> Rp{{ number_format(App\Http\Controllers\PrintController::sumTotalByProgram($tipe, $data->id_pengajuan, 'MOBIL JENAZAH'), 0, '.', '.') }}</b>@endif
                @endif
                @endif @if ($data->tingkat == 'Ranting NU')@if ($tipe == 'bmt')Kelembagaan
                    ...
                    <br> Sosial
                    <br><b>Rp{{ number_format(App\Http\Controllers\PrintController::sumTotalByProgram2($tipe, $data->id_pengajuan, 'bed10d9c-81a8-11ed-b4ef-dc215c5aad51'), 0, '.', '.') }}</b>
                    <br>
                    @elseif($tipe == 'bri')Kelembagaan ({{ App\Http\Controllers\PrintController::getDataRekening3('ranting', $tipe, $data->id_ranting, 'LEMBAGA')->pluck('no_rekening')->first() ?? null }})
                    <br><b>Rp{{ number_format(App\Http\Controllers\PrintController::sumTotalByProgram($tipe, $data->id_pengajuan, 'LEMBAGA'), 0, '.', '.') }}</b>
    ...
    <table style="width: 100%;font-size:11pt;">
        ...
        <tr>
            ...
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU'){{ App\Http\Controllers\Helper::getNamaPengurus('upzis', $data->pj_upzis) }}@endif @if ($data->tingkat == 'Ranting NU'){{App\Http\Controllers\Helper::getNamaPengurus('ranting', $data->pj_ranting) }}@endif</td>
        </tr>
        <tr>
            <td style="width: 38%">Alamat Lengkap</td>
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU'){{ App\Http\Controllers\Helper::getAlamatPengurus('upzis', $data->pj_upzis) }}@endif @if ($data->tingkat == 'Ranting NU'){{App\Http\Controllers\Helper::getAlamatPengurus('ranting', $data->pj_ranting) }}@endif
            </td>
        </tr>
        <tr>
            <td style="width: 38%">No. Telp</td>
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU'){{ App\Http\Controllers\Helper::getNohpPengurus('upzis', $data->pj_upzis) }} @endif  @if ($data->tingkat == 'Ranting NU'){{App\Http\Controllers\Helper::getNohpPengurus('ranting', $data->pj_ranting) }} @endif</td>
        </tr>
        <tr>
            <td style="width: 38%">Jabatan</td>
            <td style="width: 2%">:</td>
            <td style="width: 60%">@if ($data->tingkat == 'Upzis MWCNU'){{ App\Http\Controllers\Helper::getJabatanPengurus('upzis', $data->pj_upzis) }} @endif @if ($data->tingkat == 'Ranting NU'){{App\Http\Controllers\Helper::getJabatanPengurus('ranting', $data->pj_ranting) }}@endif
            </td>
        </tr>
