<div wire:ignore.self class="modal fade" id="modal_pengeluaran_hapus" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="hapus_pengeluaran()" class="btn btn-danger close-modal"
