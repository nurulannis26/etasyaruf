            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="tambah_pengajuan_pc">
                    ...
                    <div class="modal-footer">
                        @if ($tab_p1_show_active == 'show active')
                            <button type="button"
                            ...
                            @if ($this->sumber_dana == 'Dana Zakat')
                                ...
                                @else
                                    <button class="btn btn-success" wire:loading.attr="disabled"><i
                                        ...
                                        Simpan</button>
                                @endif
                            @elseif ($this->sumber_dana == 'Dana Infak')
                                @if (
                                    $nomor_surat == '' ||
                                        $opsi_pemohon == '' ||
                                        $tgl_pengajuan == '' ||
                                ...
                                @endif
                            @else
                                <button type="button" class="btn btn-success" wire:loading.attr="disabled" disabled><i
                                        class="fas fa-save"></i>
                                    Simpan</button>
                            @endif
                        @endif
                        {{-- @if ($tab_p2_show_active == 'show active')
                            <a wire:click="kembali" class="btn btn-primary mr-auto balik"><i class="fas fa-next"></i>
                                <i class="fas fa-backward"></i> Kembali </a>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i
                                    class="fas fa-ban"></i>
                                Batal</button>
                            @if ($id_asnaf)
                                @if ($id_asnaf == '' || $nama_penerima == '' || $jumlah_penerima == '' || $satuan_pengajuan == '')
                                    <button class="btn btn-success" disabled wire:loading.attr="disabled"><i
                                            class="fas fa-save"></i>
                                        Simpan</button>
                                @else
                                ...
                                @endif
                            @else
                                @if ($id_program_pilar == '' or $id_program_kegiatan == '' or $nama_penerima == '' or $jumlah_penerima == '' or $satuan_pengajuan == '')
                                    <button class="btn btn-success" disabled wire:loading.attr="disabled"><i
                                            class="fas fa-save"></i>
                                        Simpan</button>
                                @else
