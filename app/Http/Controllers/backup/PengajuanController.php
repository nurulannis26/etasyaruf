...
class PengajuanController extends Controller
{
    ...
    public function pdf_umum_upzis($role, $status, $start_date, $end_date, $filter_daterange, $id_upzis, $id_upzis2, $id_ranting2, $status2, $filter_daterange2, $sub)
    {
        $sub = $sub;
    ...
    public function pdf_umum_ranting($role, $status, $start_date, $end_date, $filter_daterange, $id_upzis, $id_upzis2, $id_ranting2, $status2, $filter_daterange2, $sub)
    {
        $sub = $sub;
        // Memecah string tanggal menjadi dua bagian berdasarkan tanda "-"
        $date_parts = explode(" - ", $filter_daterange2);
    ...
    public function excel_umum_ranting($role, $status, $start_date, $end_date, $filter_daterange, $id_upzis, $id_upzis2, $id_ranting2, $status2, $filter_daterange2, $sub)
    {
    ...
    public function excel_umum_upzis($role, $status, $start_date, $end_date, $filter_daterange, $id_upzis, $id_upzis2, $id_ranting2, $status2, $filter_daterange2, $sub)
    {
