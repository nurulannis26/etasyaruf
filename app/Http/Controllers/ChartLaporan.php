...
class ChartLaporan extends Controller
{
    ...
    public static function getTotalByPilar($tingkat, $id_upzis, $id_ranting, $id_pilar, $start_date, $end_date, $status_lpj)
    {
        // dd($status_lpj);
    ...
    public static function getTotalByNominal($tingkat, $id_upzis, $id_ranting, $id_pilar, $start_date, $end_date, $status_lpj)
    {
        $cek_status_berita = PengajuanDetail::where('status_berita', '!=', 'Sudah Diperiksa')->get();
        self::initConfig();
        $data = DB::table(self::$etasyaruf . '.pengajuan')
