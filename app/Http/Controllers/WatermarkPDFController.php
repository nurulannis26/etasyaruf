...
// dd($data->file_berita);
            ...
            // Dump information about the exception for debugging
            dd('Format File PDF Beda Versi, Silahkan menggunakan format pdf versi 1.4 , file => ' . $data->file_berita);
        
            // You may want to handle the exception in a specific way or return a response
            // For example, return response()->json(['error' => $e->getMessage()], 500);
        }
