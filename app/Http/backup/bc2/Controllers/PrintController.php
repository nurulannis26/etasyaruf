...
class PrintController extends Controller
{
    ...
    public function print($id_pengajuan)
    {
        ...
        $html2 = view('print.daftar_rencana', compact(
            'nama_upzis',
            'nama_ranting',
            'data',
            'rencana_a',
    ...
    //     $m = new Merger();
    //     $pdf = Dompdf::loadview('print.rekomendasi', compact(
    //         'data',
    //         'tipe',
    //         'rekening',
    //     ))->setPaper('a4', 'potrait');
    //     $m->addRaw($pdf->output());
    //     $pdf2 = Dompdf::loadview('print.daftar_rencana2', compact(
    //         'data',
    //         'tipe',
    //         'rencana_a',
    //         'jumlah_nominal_a',
     ...
     public function rekomendasi($tipe, $id_pengajuan)
    {
        ...
        // Load and render the second view
        $html2 = view('print.daftar_rencana2', compact(
            'data',
            'tipe',
            'rencana_a',
            'jumlah_nominal_a',
    ...
    //     $m = new Merger();
    //     $pdf = Dompdf::loadview('print.berita_acara_upzis_ranting', compact(
    //         'data',
    //         'nama_pc',
    //         'nama_upzis',
    //         'nama_ranting',
    ...
    //     $pdf2 = Dompdf::loadview('print.lampiran_serah_terima_bantuan', compact(
    //         'data',
    //         'data_penerima_lpj',
    //         'nama_pc',
    //         'nama_upzis',
       ...
       public function berita_upzis_ranting($id_pengajuan_detail)
    {
        ...
        // Load and render the second view
        $html3 = view('print.kwitansi', compact(
            'data',
            'nama_pc',
            'nama_upzis',
            'nama_ranting',
     ...
     public function berita_acara_umum_pc($id_pengajuan_detail)
    {
        ...
        // Load and render the second view
        $html2 = view('print.lampiran_serah_terima_bantuan_umum_pc', compact(
            'data',
            'data_penerima_lpj',
            'nama_pc',
            'nama_upzis',
    ...
    public function survey($id)
    {
        ...
        $nama = Pengguna::join($gocap . '.pc_pengurus', 'pc_pengurus.id_pc_pengurus', '=', 'pengguna.gocap_id_pc_pengurus')
            ...
            ->where('jabatan', 'Divisi Penyaluran')->first()->nama;
        // dd($s);
    ...
    public function internal($id_internal)
    {
        ...
        $jabatans = ['Direktur Eksekutif', 'Divisi Keuangan', 'Divisi Program dan Administrasi Umum'];
