...
class DetailPengajuan extends Component
{
    ...
    public function detail_rencana($id)
    {
        ...
        $this->data_penerima = PengajuanPenerima::where('id_pengajuan_detail', $id)->get();
    ...
    public function penerimaValidation()
    {
        ...
        if ($this->penerima_manfaat and $this->nominal_bantuan and $this->alamat_penerima and $this->penerima_note) {
            return 1;
        } else {
            return 0;
        }
